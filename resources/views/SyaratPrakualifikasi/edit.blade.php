                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        @foreach ($aspekLegalLokal as $key => $itemLokal)
                                            <tr>
                                                ...
                                                <td>{{ $itemLokal->isi }}</td>
                                                <td>
                                                    <input type="hidden" name="index_wika[]" id="index_{{ $itemLokal->id }}" value="{{ $itemLokal->posisi }}">
                                                    <input type="hidden" name="aspek_wika[]" id="aspek" value="{{ $itemLokal->kategori }}">
                                                    <div class="">
                                                        <select name="aspek_legal_lokal_wika[]" id="aspek_legal_lokal_{{ $itemLokal->id }}" 
                                        ...
                                        @foreach ($aspekLegalAsing as $key => $itemAsing)
                                            <tr>
                                                ...
                                                <td>{{ $itemAsing->isi }}</td>
                                                <td>
                                                    <input type="hidden" name="index_wika[]" id="index_{{ $itemAsing->id }}" value="{{ $itemAsing->posisi }}">
                                                    <input type="hidden" name="aspek_wika[]" id="aspek" value="{{ $itemAsing->kategori }}">
                                                    <div class="">
                                                        <select name="aspek_legal_asing_wika[]" id="aspek_legal_asing_{{ $itemAsing->id }}" 
                                                        class="form-select form-select-solid select2-hidden-accessible"
                                                        data-control="select2" data-hide-search="true" data-placeholder="Perlu / Tidak Perlu"
                                        ...
                                        @foreach ($aspekTeknikal as $key => $itemTeknikal)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="index_wika[]" id="index_{{ $itemTeknikal->id }}" value="{{ $itemTeknikal->posisi }}">
                                                    <input type="hidden" name="aspek_wika[]" id="aspek" value="{{ $itemTeknikal->aspek }}">
                                                    <div class="">
                                        ...
                                        @foreach ($aspekKomersial as $key => $itemKomersial)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="index_wika[]" id="index_{{ $itemKomersial->id }}" value="{{ $itemKomersial->posisi }}">
                                                    <input type="hidden" name="aspek_wika[]" id="aspek" value="{{ $itemKomersial->aspek }}">
                                                    <div class="">
