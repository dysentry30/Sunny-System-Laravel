                                ...
                                @foreach ($proyeks as $proyek)
                                    <tbody class="fw-bold text-gray-600">
                                        <tr>
                                            ...
                                            <!--begin::Name=-->
                                            <td>
                                                <a href="/proyek/view/{{ $proyek->id }}" id="click-name"
                                            ...
                                            <td>
                                                <!--begin::Button-->
                                                <form action="/proyek/delete/{{ $proyek->id }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
                                                    <center>
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select name="unit-kerja" class="form-select form-select-solid" data-control="select2"
                                        data-hide-search="true" data-placeholder="Unit Kerja">
                                        <option></option>
                                        @foreach ($unitkerjas as $unitkerja)
                                            @if ($unitkerja->unit_kerja == null)
                                                <option value="{{ $unitkerja->divcode }}" selected>
                                                    {{ $unitkerja->unit_kerja }}</option>
                                            @else
                                                <option value="{{ $unitkerja->divcode }}">{{ $unitkerja->unit_kerja }}
                                                </option>
                                            @endif
                                        @endforeach
                                    </select>
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid reformat" id="nilai-rkap"
                                        name="nilai-rkap" value="" placeholder="Nilai OK RKAP" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="number" class="form-control form-control-solid" id="tahun-perolehan"
                                        name="tahun-perolehan" min="2021" max="2099" step="1" value="2022" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
