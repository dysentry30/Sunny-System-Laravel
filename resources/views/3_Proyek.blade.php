...
<html lang="en">
	...
	<head><base href="">
		...
		<link rel="shortcut icon" href="assets/media/logos/Icon-CCM.png" />
		<!--begin::Fonts-->
				...
				style="background-color:#535353;">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo" style="background-color:#535353;">
						...
						<a href="#" style="background-color:#535353;">
							<img alt="Logo" src="assets/media/logos/Logo2.png" class="h-70px logo" 
					...
					<div class="aside-menu flex-column-fluid" style="background-color:#535353;margin-top:40px;">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;">
								<div class="menu-item">
									<a class="menu-link active" href="1_Dashboard.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/dashboards.svg" class="h-35px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="2_Customer.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/account.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#ff7f00;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="3_Proyek.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/opportunity.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="4_Contract.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/contract.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="5_Claim.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/releases.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="6_Document.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/documents.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="7_KPI.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/bonus_rules.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="8_Knowledge_Base.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/knowledge_base.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="9_Change_request.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/changes.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
							...
							<div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
								<div class="menu-item">
									<a class="menu-link active" href="10_Stakeholder_Communication.html" style="color:white;">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
											<span class="svg-icon svg-icon-2">
												<img alt="Logo" src="assets/media/icons/duotune/creatio/feed.svg" class="h-30px logo"/>
											</span>
											<!--end::Svg Icon-->
										</span>
									...
									<div class="d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												...
												<img src="assets/media/avatars/User-Icon.png" alt="user" />
											</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-2" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Stage</th>
														<th class="min-w-125px">Nilai RKAP</th>
														<th class="min-w-125px">Nilai Forecast</th>
														<th class="min-w-125px">Nilai Realisasi</th>
														<th class="min-w-125px">Jenis Proyek</th>
														<th class="min-w-125px">Tipe Proyek</th>
													</tr>
													<!--end::Table row-->
												</thead>
												<!--end::Table head-->
												...
												<tbody class="fw-bold text-gray-600">
													<tr>
														...
														<td>
															...
															class="text-gray-800 text-hover-primary mb-1">3EPA050</a>
														</td>
														<!--end::Name=-->
														<!--begin::Email=-->
														<td>
															PENGADAAN STEEL GIRDER BAJA JUNCTION CISUMDAWU-CIPALI KM. 152
														</td>
														<!--end::Email=-->
														<!--begin::Company=-->
														<td>Divisi Infrastruktur 1</td>
														<!--end::Company=-->
														...
														<!--begin::Action=-->
														<td>
															1,563,330,000,000.00
														</td>
													<!--end::Action=-->
													<!--begin::Action=-->
													<td>1,563,330,000,000</td>
													<!--end::Action=-->
													<!--begin::Action=-->
													<td>Extern</td>
													<!--end::Action=-->
