                                                    ...
                                                    <div class="tab-pane fade" id="kt_user_view_company" role="tabpanel">
                                                        ...
                                                        <div class="row fv-row space-between">
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <!--begin::Input-->
                                                                <div id="div-tax">
                                                                    <input type="text" name="kode-bp" id="kode-bp" class="form-control form-control-solid" placeholder="Kode BP" value="{{$customer->kode_bp ?? ""}}" readonly>
                                                                </div>
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--ENd::Row-->
                                                                    ...
                                                                    <tbody class="fw-bold text-gray-600">
                                                                        @if (isset($proyekberjalan))
                                                                            @foreach ($proyekberjalan as $proyekberjalan0)
                                                                                @if ($proyekberjalan0->stage == 8 && !empty($proyekberjalan0->proyek))
                                                                                    <tr>
                                                                                        <!--begin::Kode-->
                                                                                        <td>
                                                                                        ...
                                                                                        <!--end::Unit-->
                                                                                        <!--begin::Nilai OK-->
                                                                                        <td>{{ number_format((int) $proyekberjalan0->proyek->nilai_rkap, 0, '.', '.') }}
                                                                                        </td>
                                                                                        <!--end::Nilai OK-->
                                                                                        <!--begin::Start-->
                                                                                        <td>
                                                                                        ...
                                                                                        <td>
                                                                                            @php
                                                                                                $tglakhir = new DateTime($proyekberjalan0->proyek->tanggal_akhir_terkontrak ?? Carbon\Carbon::now());
                                                                                                $tglawal = new DateTime($proyekberjalan0->proyek->tanggal_mulai_terkontrak ?? Carbon\Carbon::now());
                                                                ...
                                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                                                    ...
                                                                    <tbody class="fw-bold text-gray-600">
                                                                        @if (isset($proyekberjalan))
                                                                            @foreach ($proyekberjalan as $proyekberjalan0)
                                                                            @if (!empty($proyekberjalan0->proyek->ContractManagements))
                                                                                @if ($proyekberjalan0->stage == 8 && $proyekberjalan0->proyek->ContractManagements->stages == 4 && !empty($proyekberjalan0->proyek))
                                                                                    <tr>
                                                                                        <!--begin::Kode-->
                                                                                        <td>
                                                                                            <a href="#" data-bs-toggle="modal"
                                                                                        ...
                                                                                        <!--end::Unit-->
                                                                                        <!--begin::Nilai OK-->
                                                                                        <td>{{ number_format((int) $proyekberjalan0->proyek->nilai_rkap ?? 0, 0, '.', '.') }}
                                                                                        </td>
                                                                                        <!--end::Nilai OK-->
                                                                                        <!--begin::Start-->
                                                                                        <td>
