...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Approval Verifikasi Proyek Greenlane / Non Greenlane
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--begin::Page title-->
    ...
    @foreach ($dataProyekProsesVerifikasi as $proyek)
        <form action="/verifikasi-proyek-nota-2/pengajuan/{{ $proyek->id }}" method="post" onsubmit="addLoading(this)">
            @csrf
        ...
        <form action="/verifikasi-proyek-nota-2/rekomendasi/{{ $proyek->id }}" method="post" onsubmit="addLoading(this)">
            @csrf
        ...
        <form action="/verifikasi-proyek-nota-2/persetujuan/{{ $proyek->id }}" method="post" onsubmit="addLoading(this)">
            @csrf
