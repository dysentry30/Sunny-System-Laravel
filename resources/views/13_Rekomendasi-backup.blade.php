...
{{-- End :: css --}}
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="form-check" id="kriteria">
                                                                                <input class="form-check-input" type="radio" name="is_legalitas" id="is_legalitas_{{ $key }}" value="{{ $key+1 }}">
                                                                        ...
                                                                        <td class="d-none">
                                                                            <input type="hidden" name="nilai[]" value="" form="form-kriteria-{{ $proyek->kode_proyek }}" id="nilai">
                                                                            <input type="hidden" name="index[]" value="{{ $index }}" form="form-kriteria-{{ $proyek->kode_proyek }}" id="nilai">
                                                                        </td>
                                                                        <td class="text-center">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                @if (!is_null($item->kriteria_1))
                                                                                    <div class="form-check" id="kriteria">
                                                                                        <input class="form-check-input" type="radio" name="is_kriteria_{{ $key+1 }}" id="is_kriteria_{{ $key }}_1" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 1 }}', '{{ $key }}')" value="1">
                                                                            ...
                                                                            <td>
                                                                                @if (!is_null($item->kriteria_2))
                                                                                    <div class="form-check" id="kriteria">
                                                                                        <input class="form-check-input" type="radio" name="is_kriteria_{{ $key+1 }}" id="is_kriteria_{{ $key }}_2" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 2 }}', '{{ $key }}')" value="2">
                                                                            ...
                                                                            <td>
                                                                                @if (!is_null($item->kriteria_3))
                                                                                    <div class="form-check" id="kriteria">
                                                                                        <input class="form-check-input" type="radio" name="is_kriteria_{{ $key+1 }}" id="is_kriteria_{{ $key }}_3" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 3 }}', '{{ $key }}')" value="3">
                                                                            ...
                                                                            <td>
                                                                                @if (!is_null($item->kriteria_4))
                                                                                    <div class="form-check" id="kriteria">
                                                                                        <input class="form-check-input" type="radio" name="is_kriteria_{{ $key+1 }}" id="is_kriteria_{{ $key }}_4" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 4 }}', '{{ $key }}')" value="4">
                                                                            ...
                                                                            <td>
                                                                                <input type="number" name="nilai[]" class="form-control form-control-solid" form="form-kriteria-{{ $proyek->kode_proyek }}" id="nilai_{{ $key }}" readonly>
                                                                            </td>
                                                                            <td>
                                                                                <textarea name="keterangan[]" form="form-kriteria-{{ $proyek->kode_proyek }}" id="" cols="30" rows="10"></textarea>
                                                                            </td>
    ...
    @php
        ...
        $is_edit = is_null($proyek->is_penyusun_approved) && ((!is_null($proyek->is_draft_recommend_note) && $proyek->is_draft_recommend_note) || is_null($proyek->is_draft_recommend_note));
    @endphp
    @foreach ($data as $key=>$proyek)
    @if ($is_edit)
        <form action="/kriteria-pengguna-jasa/detail/edit" method="POST" id="form-edit-kriteria-{{ $proyek->kode_proyek }}" enctype="multipart/form-data">
    @endif
        @csrf
        <div class="modal fade" id="kt_user_edit_kriteria_{{ $proyek->kode_proyek }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen">
                <!--begin::Modal content-->
                <div class="modal-content">
                            ...
                            <div class="row fv-row">
                                <table>
                                    ...
                                    <tbody>
                                        @php
                                            $legalitasJasa = App\Models\LegalitasPerusahaan::all();
                                            $kriteriaDetails = App\Models\KriteriaPenggunaJasaDetail::where('kode_proyek', $proyek->kode_proyek)->orderBy('index')->get()->unique('index');
                                            $index = 0;
                                        @endphp
                                        <tr>
                                            <td>
                                                @foreach ($legalitasJasa as $key => $item)
                                                <div class="form-check" id="kriteria">
                                                    <input class="form-check-input" type="radio" name="is_legalitas" id="is_legalitas_{{ $key }}" value="{{ $key+1 }}" {{ $kriteriaDetails->isNotEmpty() && ($kriteriaDetails[$index]->kriteria == $key+1) ? "checked" : '' }} {{ $is_edit ? '' : 'disabled' }}>
                                                    <label for="is_legalitas_{{ $key }}" class="form-check-label">
                                                        {!! nl2br($item->item) !!}
                                                    </label>
                                                </div>
                                            ...
                                            <td class="d-none">
                                                <input type="hidden" name="nilai[]" value="" form="form-edit-kriteria-{{ $proyek->kode_proyek }}" id="nilai" {{$is_edit ? '' : 'disabled'}}>
                                            </td>
                                            <td class="text-center">
                                                <textarea name="keterangan[]" form="form-edit-kriteria-{{ $proyek->kode_proyek }}" id="" cols="30" rows="10" {{$is_edit ? '' : 'disabled'}}>{!! $kriteriaDetails->isNotEmpty() ? $kriteriaDetails[$index]->keterangan : "" !!}</textarea>
                                            </td>
                                            <td class="text-center">
                                                @if ($matriks_user?->contains("kategori","Rekomendasi") && (!is_null($proyek->is_draft_recommend_note) && !$proyek->is_draft_recommend_note))
                                                    <a href="{{ $kriteriaDetails->isNotEmpty() ? asset('file-kriteria-pengguna-jasa'.'\\'.$kriteriaDetails[$index]->id_document) : "" }}" class="text-hover-primary">{{ $kriteriaDetails[$index]->id_document }}</a>
                                                @else
                                                    <input type="file" name="dokumen_penilaian[]" form="form-edit-kriteria-{{ $proyek->kode_proyek }}" id="dokumen_kriteria" class="form-control form-control-sm form-control-solid" {{$is_edit ? '' : 'disabled'}}>
                                                @endif
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <input type="hidden" name="index[]" value="{{ $index }}" {{$is_edit ? '' : 'disabled'}}>
                                <input type="hidden" name="kode_proyek" value="{{ $proyek->kode_proyek }}" {{$is_edit ? '' : 'disabled'}}>
                                <input type="hidden" name="id_detail[]" value="{{ $kriteriaDetails->isNotEmpty() ? $kriteriaDetails[$index]->id : "" }}" {{$is_edit ? '' : 'disabled'}}>
                            </div>
        
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-light btn-active-primary text-white" data-bs-toggle="modal" data-bs-target="#kt_user_edit_modal2_kriteria_{{ $proyek->kode_proyek }}" id="new_save"
                            style="background-color:#008CB4">Next</button>
        ...
        <div class="modal fade" id="kt_user_edit_modal2_kriteria_{{ $proyek->kode_proyek }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-fullscreen">
                <!--begin::Modal content-->
                <div class="modal-content">
                                        ...
                                        @foreach ($kriteriaPengguna as $keys=>$item)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!is_null($item->kriteria_1))
                                                        <div class="form-check" id="kriteria">
                                                            <input class="form-check-input" type="radio" name="is_kriteria_{{ $keys+1 }}" id="is_kriteria_{{ $keys }}_1" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 1 }}', '{{ $keys }}')" value="1" {{ $kriteriaDetails->isNotEmpty() && ($kriteriaDetails[$keys+1]->kriteria == 1) ? "checked" : '' }} {{ $is_edit ? '' : 'disabled' }}>
                                                            <label for="is_kriteria_{{ $keys }}_1" class="form-check-label">
                                                                {!! nl2br($item->kriteria_1) !!}
                                                            </label>
                                                        </div>
                                                    @endif
                                                ...
                                                <td>
                                                    @if (!is_null($item->kriteria_2))
                                                        <div class="form-check" id="kriteria">
                                                            <input class="form-check-input" type="radio" name="is_kriteria_{{ $keys+1 }}" id="is_kriteria_{{ $keys }}_2" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 2 }}', '{{ $keys }}')" value="2" {{ $kriteriaDetails->isNotEmpty() && ($kriteriaDetails[$keys+1]->kriteria == 2) ? "checked" : '' }} {{ $is_edit ? '' : 'disabled' }}>
                                                            <label for="is_kriteria_{{ $keys }}_2" class="form-check-label">
                                                                {!! nl2br($item->kriteria_2) !!}
                                                            </label>
                                                        </div>
                                                    @endif
                                                ...
                                                <td>
                                                    @if (!is_null($item->kriteria_3))
                                                        <div class="form-check" id="kriteria">
                                                            <input class="form-check-input" type="radio" name="is_kriteria_{{ $keys+1 }}" id="is_kriteria_{{ $keys }}_3" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 3 }}', '{{ $keys }}')" value="3" {{ $kriteriaDetails->isNotEmpty() && ($kriteriaDetails[$keys+1]->kriteria == 3) ? "checked" : '' }} {{ $is_edit ? '' : 'disabled' }}>
                                                            <label for="is_kriteria_{{ $keys }}_3" class="form-check-label">
                                                                {!! nl2br($item->kriteria_3) !!}
                                                            </label>
                                                        </div>
                                                    @endif
                                                ...
                                                <td>
                                                    @if (!is_null($item->kriteria_4))
                                                        <div class="form-check" id="kriteria">
                                                            <input class="form-check-input" type="radio" name="is_kriteria_{{ $keys+1 }}" id="is_kriteria_{{ $keys }}_4" onchange="setNilaiKriteria(this, '{{ (int)$item->bobot * 4 }}', '{{ $keys }}')" value="4" {{ $kriteriaDetails->isNotEmpty() && ($kriteriaDetails[$keys+1]->kriteria == 4) ? "checked" : '' }} {{ $is_edit ? '' : 'disabled' }}>
                                                            <label for="is_kriteria_{{ $keys }}_4" class="form-check-label">
                                                                {!! nl2br($item->kriteria_4) !!}
                                                            </label>
                                                        </div>
                                                    @endif
                                                ...
                                                <td>
                                                    <input type="number" name="nilai[]" class="form-control form-control-solid" form="form-edit-kriteria-{{ $proyek->kode_proyek }}" value="{{ $kriteriaDetails->isNotEmpty() ? $kriteriaDetails[$keys+1]->nilai : 0 }}" id="nilai_{{ $keys }}" readonly {{ $is_edit ? '' : 'disabled' }}>
                                                </td>
                                                <td>
                                                    <textarea name="keterangan[]" form="form-edit-kriteria-{{ $proyek->kode_proyek }}" id="" cols="30" rows="10" {{ $is_edit ? '' : 'disabled' }}>{!! $kriteriaDetails->isNotEmpty() ? $kriteriaDetails[$keys+1]->keterangan : '' !!}</textarea>
                                                </td>
                                                <td class="text-start">
                                                    @if ($matriks_user?->contains("kategori","Rekomendasi") && (!is_null($proyek->is_draft_recommend_note) && !$proyek->is_draft_recommend_note))
                                                    <a href="{{ $kriteriaDetails->isNotEmpty() ? asset('file-kriteria-pengguna-jasa'.'\\'.$kriteriaDetails[$keys+1]->id_document) : "" }}" class="text-hover-primary">{{ $kriteriaDetails[$keys+1]->id_document }}</a>
                                                    @else
                                                    <input type="file" name="dokumen_penilaian[]" form="form-edit-kriteria-{{ $proyek->kode_proyek }}" id="dokumen_kriteria" class="form-control form-control-sm form-control-solid" {{ $is_edit ? '' : 'disabled' }}>
                                                ...
                                                <input type="hidden" name="index[]" value="{{ $keys+1 }}" {{ $is_edit ? '' : 'disabled' }}>
                                                <input type="hidden" name="id_detail[]" value="{{ $kriteriaDetails->isNotEmpty() ? $kriteriaDetails[$keys+1]->id : "" }}" {{ $is_edit ? '' : 'disabled' }}>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-light btn-secondary" data-bs-toggle="modal" data-bs-target="#kt_user_edit_kriteria_{{ $proyek->kode_proyek }}" id="new_save">
                            Back</button>
                        @if ($matriks_user?->contains("kategori","Rekomendasi") && (!is_null($proyek->is_draft_recommend_note) && !$proyek->is_draft_recommend_note))
                        <button type="button" class="btn btn-sm btn-light btn-active-primary text-white" data-bs-dismiss="modal"
                            style="background-color:#008CB4">Close</button>
                        @else
                        <button type="submit" class="btn btn-sm btn-light btn-active-primary text-white" form="form-edit-kriteria-{{ $proyek->kode_proyek }}" id="new_save"
                            style="background-color:#008CB4">Save</button>
                        @endif
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <b><p class="p-1">Pengajuan Rekomendasi Seleksi Pengguna Jasa Non Green Lane</p></b>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    @endif
                        ...
                        <div class="modal-body">
                            <b><p>Nota Rekomendasi Tahap I Seleksi Pengguna Jasa Non Green Lane</p></b>
                            <table class="table table-striped">
                                <thead>
                                    <tr class="text-bg-dark">
                                        <th>No</th>
                                ...
                                <tbody>
                                    @php
                                    $nilaiKriteriaPenggunaJasa = $proyek->KriteriaPenggunaJasaDetail?->filter(function($score){
                                    ...
                                    <tr>
                                        <td>8</td>
                                        <td>
                                            <a href="/customer/view/{{ $proyek->proyekBerjalan->customer->id_customer }}/{{ $proyek->proyekBerjalan->customer->name }}" target="_blank" class="text-hover-primary">
                                    ...
                                    <tr>
                                        <td>10</td>
                                        <td>
                                            <a href="#kt_user_edit_kriteria_{{ $proyek->kode_proyek }}" target="_blank" data-bs-toggle="modal" class="text-hover-primary">
                        ...
                        <div class="modal-footer row">
                            ...
                            @if (is_null($proyek->is_recommended))
                                ...
                                <textarea class="form-control form-control-solid" id="note-rekomendasi" name="note-rekomendasi" rows="10" {{ !is_null($proyek->is_draft_recommend_note) && !$proyek->is_draft_recommend_note ? 'readonly' : ''}} >{!! is_null($proyek->is_draft_recommend_note) ? "Profile Risiko Pengguna Jasa = ".$text." (Score : ".$nilaiKriteriaPenggunaJasa.")\n\n" : $proyek->recommended_with_note !!}</textarea>
                                <br>
                                @csrf
                                <input type="hidden" name="kode-proyek" value="{{$proyek->kode_proyek}}">
                                @if (is_null($proyek->is_draft_recommend_note) || $proyek->is_draft_recommend_note)
                        ...
                        <div class="modal-footer row">
                            ...
                            @elseif ((is_null($proyek->is_recommended)) && $matriks_user->contains("kategori", "Rekomendasi") && $proyek->is_penyusun_approved && !$is_user_exist_rekomendasi)
                                <form action="" method="get">
                                    @csrf
                                    <input type="hidden" value="{{$proyek->kode_proyek}}" name="kode-proyek" id="kode-proyek">
                                    <span><b>Hasil Kriteria Pengguna Jasa</b> <a href="#kt_user_edit_kriteria_{{ $proyek->kode_proyek }}" class="btn btn-sm btn-primary" data-bs-toggle="modal">Lihat</a></span>
                                    <br>
                                    ...
                                    <select id="kategori-rekomendasi" name="kategori-rekomendasi"
                                        ...
                                        style="margin-right: 2rem;" data-control="select2" data-hide-search="true"
                                        data-placeholder="Pilih Kategori" data-select2-id="select2-data-kategori-rekomendasi" tabindex="-1"
                                        aria-hidden="true">
                                        <option value=""></option>
                            ...
                            @elseif (is_null($proyek->is_disetujui) && $matriks_user?->contains("kategori", "Persetujuan") && $proyek->is_recommended && !$is_user_exist_persetujuan)
                                <form action="" method="get">
                                    ...
                                    @endif
                                    <input type="hidden" value="{{$proyek->kode_proyek}}" name="kode-proyek" id="kode-proyek">
                                    <label class="text-start">Catatan Penyusun:</label>
                                    <p>{!! nl2br($proyek->recommended_with_note) !!}</p>
                                    <br>
                                    <label class="text-start">Catatan Rekomendasi:</label>
                                    {{-- @dump(json_decode($proyek->approved_rekomendasi_final)[0]->alasan) --}}
                                    <p>{!! nl2br(json_decode($proyek->approved_rekomendasi_final)[0]->alasan) !!}</p>
                                    <br>
