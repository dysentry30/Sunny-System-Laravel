...
<!--begin:::Tab Forecast Retail-->
                <div class="tab-pane fade show active" id="kt_user_view_overview_forecast" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        @php
                        $now_pane = Carbon\Carbon::now()->setDays(1)->subMonths($submonth-1);
                        @endphp
                        <div class="tab-content">
                            @foreach (range(1,$submonth) as $item)
                            {{-- @dump("sub: ".$submonth, "item: ".$item) --}}

                                <!--begin:::Tab Pane Forecasts-->
                                <div class="tab-pane fade {{$item == $submonth ? "show active" : ""}}" id="kt_user_view_forecasts_{{(int) $now_pane->format("m")}}_{{$now_pane->format("Y")}}" role="tabpanel">
                                    <!--begin::Table-->
                                                            ...
                                                            @if (count($forecasts) > 0)
                                                                ...
                                                                <td class="text-dark">
                                                                    <input type="text"
                                                                        ...
                                                                        {{-- placeholder="Nilai Perolehan" {{(!$is_admin && (($i <= $listPeriodeExistInHistory->last()) || ($i <= ((int) $listPeriodeExistInHistory->last() - 1)))) || $now_pane->format('m') < date('m')  ? "disabled" : "" }} /> --}}
                                                                        placeholder="Nilai Perolehan" {{ !$is_admin && $i <= $listPeriodeExistInHistory->last() || ( $is_admin && $i <= ((int) $listPeriodeExistInHistory->last() - 1)) ? "disabled" : "" }} {{ $i != ((int) $currMonth-1) && (int) date('d') <= 5 && $is_periode_unlock && $i < $forecast->periode_prognosa && !$is_admin ? "disabled" : "" }} />
                                                                </td>
                                                                <td class="text-dark">
                                                                    <input type="text"
                                                                        class="text-end form-control form-control-solid reformat-retail"
                                                                        ...
                                                                        {{-- placeholder="Nilai Forecast" {{(!$is_admin && (($i <= $listPeriodeExistInHistory->last()) || ($i <= ((int) $listPeriodeExistInHistory->last() - 1)))) || $now_pane->format('m') < date('m')  ? "disabled" : "" }} /> --}}
                                                                        placeholder="Nilai Forecast" {{ !$is_admin && $i <= $listPeriodeExistInHistory->last() || ( $is_admin && $i <= ((int) $listPeriodeExistInHistory->last() - 1)) ? "disabled" : "" }} {{ $i != ((int) $currMonth-1) && (int) date('d') <= 5 && $is_periode_unlock && $i < $forecast->periode_prognosa && !$is_admin ? "disabled" : "" }} />
                                                                </td>
                                                                <td class="text-dark">
                                                                    <input type="text"
                                                                        class="text-end form-control form-control-solid reformat-retail"
                                                                        ...
                                                                        {{-- placeholder="Nilai Realisasi" {{(!$is_admin && (($i <= $listPeriodeExistInHistory->last()) || ($i <= ((int) $listPeriodeExistInHistory->last() - 1)))) || $now_pane->format('m') < date('m')  ? "disabled" : "" }} /> --}}
                                                                        placeholder="Nilai Realisasi" {{ !$is_admin && $i <= $listPeriodeExistInHistory->last() || ( $is_admin && $i <= ((int) $listPeriodeExistInHistory->last() - 1)) ? "disabled" : "" }} {{ $i != ((int) $currMonth-1) && (int) date('d') <= 5 && $is_periode_unlock && $i < $forecast->periode_prognosa && !$is_admin ? "disabled" : "" }} />
                                                                </td>
                                                                <!--begin::input-->
                                                                <td class="text-center">
                                                                    {{-- @if ($now_pane->format('m') < date('m'))
                                                                        <span class="badge badge-danger "> Lock </span>
                                                                    @else
                                                                        @if(($proyek->is_cancel != false || ($i == $currMonth-1 && (int) date('d') <= 20 )))
                                                                        <button type="submit" class="btn btn-sm btn-light btn-active-primary"
                                                                        id="forecast-save">
                                                                        Save</button>
                                                                        @elseif (($proyek->is_cancel != false || ($i >= $forecast->periode_prognosa  )))
                                                                        <button type="submit" class="btn btn-sm btn-light btn-active-primary"
                                                                            id="forecast-save">
                                                                            Save</button>
                                                                        @else
                                                                ...
                                                                <!--end::Button-->
                                                            @else
                                                                @if ( $i == ($currMonth-1) && (int) date('d') <= 20)
                                                                    <td class="text-dark">
                                                                        <input type="text"
                                                                            class="text-end form-control form-control-solid reformat-retail"
                                                                            id="nilaiok-{{ $i }}"
                                                                ...
                                                                @else
                                                                    <td class="text-dark">
                                                                        <input type="text"
                                                                            ...
                                                                            id="nilaiok-{{ $i }}"
                                                                            name="nilaiok-{{ $i }}"
                                                                            placeholder="Isi Nilai Perolehan" {{ !$is_admin && $i <= $listPeriodeExistInHistory->last() || ( $is_admin && $i <= ((int) $listPeriodeExistInHistory->last() - 1)) ? "disabled" : "" }} {{ ( $i != ((int) $currMonth-1) && (int) date('d') <= 5 && $i < $currMonth) && !$is_admin ? "disabled" : "" }} />
                                                                            {{-- placeholder="Isi Nilai Perolehan" {{ !$is_admin && ($i < (int) date("m") ) ? "disabled" : "" }}  --}}
                                                                            {{-- /> --}}
                                                                    </td>
                                                                    <td class="text-dark">
                                                                        <input type="text"
                                                                            ...
                                                                            id="nilaiforecast-{{ $i }}"
                                                                            name="nilaiforecast-{{ $i }}"
                                                                            {{-- placeholder="Isi Nilai Forecast" {{ !$is_admin && ($i < (int) date("m") ) ? "disabled" : ""}} --}}
                                                                            placeholder="Isi Nilai Forecast" {{ !$is_admin && $i <= $listPeriodeExistInHistory->last() || ( $is_admin && $i <= ((int) $listPeriodeExistInHistory->last() - 1)) ? "disabled" : "" }} {{ ( $i != ((int) $currMonth-1) && (int) date('d') <= 5 && $i < $currMonth) && !$is_admin ? "disabled" : "" }} 
                                                                            {{-- placeholder="Isi Nilai Forecast"  --}}
                                                                        />
                                                                    </td>
                                                                    <td class="text-dark">
                                                                        <input type="text"
                                                                            ...
                                                                            id="nilairealisasi-{{ $i }}"
                                                                            name="nilairealisasi-{{ $i }}"
                                                                            {{-- placeholder="Isi Nilai Realisasi" {{ !$is_admin && ($i < (int) date("m") ) ? "disabled" : ""}} --}}
                                                                            placeholder="Isi Nilai Realisasi" {{ !$is_admin && $i <= $listPeriodeExistInHistory->last() || ( $is_admin && $i <= ((int) $listPeriodeExistInHistory->last() - 1)) ? "disabled" : "" }} {{ ( $i != ((int) $currMonth-1) && (int) date('d') <= 5 && $i < $currMonth) && !$is_admin ? "disabled" : "" }} 
                                                                            {{-- placeholder="Isi Nilai Realisasi" --}}
                                                                        />
                                                                    </td>
                                                                @endif
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    @else
                                                                        @if (($proyek->is_cancel != false || ($is_admin && $i >= ($currMonth - $i)) || (!$is_admin && $i >= $currMonth) ))
                                                                        {{-- @if ($proyek->is_cancel == false && !empty($forecast)) --}}
                                                                        <button type="submit" class="btn btn-sm btn-light btn-active-primary"
                                                                            id="forecast-save">
                                                                            Save</button>
...
@section('js-script')
    ...
    @php
        ...
        for ($i=1; $i < (int) $currMonth; $i++) { 
            array_push($listPeriodeExistIn, $i);
        };
        $listPeriodeExistIn = collect($listPeriodeExistIn);
    @endphp
    <script>
        // let isPeriodeExistInHistory = JSON.parse(`{{ $listPeriodeExistInHistory->toJson() }}`);
        let isPeriodeExistInHistory = JSON.parse(`{{ $listPeriodeExistIn->toJson() }}`);
        const isAdmin = Boolean("{{ $is_admin }}");
        console.log(isAdmin);
        isPeriodeExistInHistory.pop();
        console.log(isPeriodeExistInHistory);
        isPeriodeExistInHistory.forEach(periode => !isAdmin ? disabledPeriodeInputs(periode) : ""); 
