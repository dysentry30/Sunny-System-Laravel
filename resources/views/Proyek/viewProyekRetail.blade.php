                                    ...
                                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                        ...
                                        <div class="card-body pt-5">
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="tab-pane fade " id="kt_user_view_overview_pasardini"
                                                    role="tabpanel">
                                                    ...
                                                    <div class="row fv-row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <select id="ra-klasifikasi-proyek"
                                                                    name="ra-klasifikasi-proyek"
                                                                    class="form-select form-select-solid"
                                                                    data-control="select2" data-hide-search="true"
                                                                    data-placeholder="RA Klasifikasi Proyek">
                                                                    <option value="" selected></option>
                                                                    <option value="Proyek Kecil">Proyek Kecil</option>
                                                                    <option value="Proyek Menengah">Proyek Menengah
                                                                    </option>
                                                    ...
                                                    <h3 class="fw-bolder m-0" id="HeadDetail" style="font-size:14px;">
                                                        Nilai RKAP Review &nbsp;
                                                        <i onclick="hideReview()" id="hide-review" style="display: none"
                                                            class="bi bi-arrows-collapse"></i><i onclick="showReview()"
                                                            id="show-review" class="bi bi-arrows-expand"></i>
                                                    </h3>
                                                    <script>
                                                        function hideReview() {
                                                    ...
                                                    <h3 class="fw-bolder m-0" id="HeadDetail" style="font-size:14px;">
                                                        Nilai RKAP Awal &nbsp;
                                                        <i onclick="hideColumn()" id="hide-button" style="display: none"
                                                            class="bi bi-arrows-collapse"></i><i onclick="showColumn()"
                                                            id="show-button" class="bi bi-arrows-expand"></i>
                                                    </h3>
                                                    <script>
                                                        function hideColumn() {
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <select id="mata-uang-awal" name="mata-uang-awal"
                                                                        class="form-select form-select-solid"
                                                                        data-control="select2" data-hide-search="true"
                                                                        data-placeholder="Pilih Mata Uang" readonly>
                                                                        <option></option>
                                                                        <option value="Rupiah"
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="fv-row">
                                                                            ...
                                                                            <select id="detail-jo" name="detail-jo"
                                                                                ...
                                                                                data-placeholder="Pilih Jenis JO"
                                                                                readonly="" tabindex="-1"
                                                                                aria-hidden="true"
                                                                                data-select2-id="select2-data-jenis-jo">
                                                                                <option value="" selected></option>
                                                                                <option value="30">JO Integrated Leader
                                                                                </option>
                                                                                <option value="31">JO Integrated Member
                                                                                </option>
                                                                                <option value="40">JO Portion Leader
                                                                                </option>
                                                                                <option value="41">JO Portion Member
                                                                                </option>
                                                                                <option value="50">JO Mix Integrated -
                                                                                    Portion</option>
                                                                            </select>
                                                                            <!--end::Label-->
                                                                            <!--begin::Label-->
                            ...
                            <span><b>Sisa Porsi JO : {{ $proyek->porsi_jo }} - </b>
                                ...
                                <b id="sisa-porsi"> = {{ $proyek->porsi_jo }}%</b></span>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" onclick="changeValueJODetail(this)"
                                                ...
                                                <div class="tab-pane fade show active" id="kt_user_view_overview_forecast"
                                                    role="tabpanel">

                                                    <!--Begin::Title Biru Form: History-->
                                                    <br>
                                                    <h3 class="fw-bolder m-0" id="HeadDetail" style="font-size:14px;">
                                                        History Forecast (Input nilai real)</h3>
                                                    ...
                                                    <div class="tab-content">
                                                        @foreach (range(1, $submonth) as $item)
                                                            ...
                                                            @if ((int) $now_pane->format('m') != $submonth)
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <thead>
                                                                            ...
                                                                            <tr
                                                                                ...
                                                                                <th class="min-w-auto text-end">Periode
                                                                                </th>
                                                                                <th class="min-w-auto text-center">Nilai OK
                                                                                </th>
                                                                                <th class="min-w-auto text-center">Forecast
                                                                                </th>
                                                                                <th class="min-w-auto text-center">
                                                                                    Realisasi</th>
                                                                        ...
                                                                        <tbody class="fw-bold text-gray-600">
                                                                            ...
                                                                            @for ($i = 1; $i <= 12; $i++)
                                                                                <form
                                                                                    ...
                                                                                    onsubmit="disabledSubmitButton(this)"
                                                                                    method="post"> @csrf
                                                                                    <input type="hidden"
                                                                                        name="kode-proyek"
                                                                                        value="{{ $proyek->kode_proyek }}"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        @php
                                                                                            ...
                                                                                            $forecast = count($forecasts) > 0 ? $forecasts->first() : null;
                                                                                        @endphp
                                                                                        {{-- @dump($history) --}}
                                                                                        ...
                                                                                        <td class="text-dark">
                                                                                            <input type="text"
                                                                                                ...
                                                                                                id="nilaiok-{{ $i }}"
                                                                                                name="nilaiok-{{ $i }}"
                                                                                                value="{{ !empty($forecast) ? number_format((int)$forecast->rkap_forecast, 0, '.', '.') : ''}}"
                                                                                        ...
                                                                                        <td class="text-dark">
                                                                                            <input type="text"
                                                                                                ...
                                                                                                value="{{ !empty($forecast) ? number_format((int)$forecast->nilai_forecast, 0, '.', '.') : ''}}"
                                                                                        ...
                                                                                        <td class="text-dark">
                                                                                            <input type="text"
                                                                                                ...
                                                                                                value="{{ !empty($forecast) ? number_format((int)$forecast->realisasi_forecast, 0, '.', '.') : ''}}"
                                                            ...
                                                            @else
                                                                @php
                                                                    $new_now_pane = (int) $now_pane->format('m') - 1;
                                                                @endphp
                                                                <!--begin:::Tab Pane Forecasts-->
                                                                <div class="tab-pane fade {{ $item == $submonth ? 'show active' : '' }}"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tbody class="fw-bold text-gray-600">
                                                                            @for ($i = 1; $i <= 12; $i++)
                                                                                <form
                                                                                    action="/proyek/forecast/{{ $i }}/{{ (int) $new_now_pane }}/{{ (int) $now_pane->format('Y') }}/retail"
                                                                                    onsubmit="disabledSubmitButton(this)"
                                                                                    method="post"> @csrf
                                                                                    <input type="hidden"
                                                                                        name="kode-proyek"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <!--begin::input-->
                                                                                        @php
                                                                                            $forecasts = $proyek->Forecasts->where('periode_prognosa', '=', (int) $new_now_pane)->filter(function ($f) use ($i) {
                                                                                                return $f->month_forecast == $i;
                                                                                            });
                                                                                            $history = $proyek->HistoryForecasts->where('periode_prognosa', (int) $new_now_pane);
