...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Provinsi
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                                    ...
                                    @foreach ($provinsi as $j)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                class="text-gray-600 text-gray text-hover-primary">{{ $j->province_id  }}</a>
                                                </a>
                                            </td>
                                            <!--end::Nama Company-->
    ...
    <!--begin::modal DELETE-->
    @foreach ($provinsi as $j)
        <form action="/jenis-proyek/delete/{{ $j->province_id  }}" method="post" enctype="multipart/form-data">
            @method('delete')
            @csrf
            <div class="modal fade" id="kt_modal_delete{{ $j->province_id  }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
