...
{{-- Begin::Title --}}
@section('title', 'Master Klasifikasi Omzet Proyek')
{{-- End::Title --}}
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Master Klasifikasi Omzet Proyek 
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            @if (auth()->user()->check_administrator || str_contains(auth()->user()->name, "(PIC)"))
                                ...
                                <div class="d-flex align-items-center py-1">
                                    ...
                                    <a  href="#" data-bs-target="#kt_modal_create_klasifikasi" data-bs-toggle="modal" class="btn btn-sm btn-primary py-3"
                                        ...
                                        Tambah Klasifikasi Omzet Proyek</a>
        ...
        <div class="modal-dialog modal-dialog-centered mw-600px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Tambah Klasifikasi Omzet Proyek</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <form action="/master-klasifikasi-omzet/save" method="POST">
                    @csrf
        ...
        <div class="modal fade" id="kt_modal_edit_klasifikasi_{{ $item->id }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-600px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2>Edit Klasifikasi Omzet Proyek</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <form action="/master-klasifikasi-omzet/update/{{ $item->id }}" method="POST">
                        @csrf
                        <input type="hidden" name="modal" value="kt_modal_create_otomasi_approval">
                        <!--begin::Modal body-->
                        <div class="modal-body py-lg-6 px-lg-6">
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                try {
                    ...
                    const req = await fetch(`{{ url('/master-klasifikasi-omzet/delete/') }}/${id}`, {
                        method: 'POST',
                        header: {
