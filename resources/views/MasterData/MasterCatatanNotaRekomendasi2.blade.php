...
{{-- Begin::Title --}}
@section('title', 'Master Catatan Nota Rekomendasi')
{{-- End::Title --}}
...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Master Catatan Nota Rekomendasi
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            @if (auth()->user()->check_administrator || str_contains(auth()->user()->name, "(PIC)"))
                                ...
                                <div class="d-flex align-items-center py-1">
                                    ...
                                    <!--begin::Button-->
                                    <a  href="#" data-bs-target="#kt_modal_create_catatan" data-bs-toggle="modal" class="btn btn-sm btn-primary py-3"
                                        style="background-color:#008CB4; padding: 6px">
                                        Tambah Master Catatan Nota Rekomendasi</a>
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td class="align-middle">{!! nl2br($item->kategori) ?? "-" !!}</td>
                                            <td class="text-center">{{ $item->urutan }}</td>
                                            <td class="text-center">{{$start_bulan}}</td>
                                            <td class="text-center">{{$finish_bulan}}</td>
                                            <td class="text-center align-middle">
                                                <div class="d-flex justify-content-center">
                                                    <a href="#" data-bs-target="#kt_modal_edit_catatan_{{$item->id }}" data-bs-toggle="modal" class="btn btn-sm btn-primary text-white" style="background-color: #008CB4;">Edit</a>
    ...
    <!--begin::Modal Tambah Master Catatan Nota Rekomendasi-->
    <div class="modal fade" id="kt_modal_create_catatan" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-600px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Tambah Master Catatan Nota Rekomendasi</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <form action="/master-catatan-rekomendasi/save" method="POST">
                    @csrf
                    ...
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="row mb-7">
                                ...
                                <input type="number" class="form-control form-control-solid" id="urutan" name="urutan">
                            </div>
                            <!--End begin::Col-->
                            ...
                            <div class="row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" id="kategori" name="kategori">
                            </div>
                            <!--End begin::Col-->
    ...
    <!--end::Modal Tambah Master Catatan Nota Rekomendasi-->

    <!--begin::Modal Edit Master Catatan Nota Rekomendasi-->
    @foreach ($data as $item)
        <div class="modal fade" id="kt_modal_edit_catatan_{{ $item->id }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-600px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2>Edit Master Catatan Nota Rekomendasi</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <form action="/master-catatan-rekomendasi/update/{{ $item->id }}" method="POST">
                        @csrf
                        <input type="hidden" name="modal" value="kt_modal_edit_catatan_{{ $item->id }}">
                        <!--begin::Modal body-->
                        <div class="modal-body py-lg-6 px-lg-6">
                            ...
                            <div class="row fv-row">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <input type="number" class="form-control form-control-solid" id="urutan" name="urutan" value="{{ $item->urutan }}">
                                </div>
                                <!--End begin::Col-->
                                ...
                                <div class="row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-solid" id="kategori" name="kategori" value="{{ $item->kategori }}">
                                </div>
                                <!--End begin::Col-->
    ...
    @endforeach
    <!--end::Modal Edit Master Catatan Nota Rekomendasi-->
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                try {
                    ...
                    const req = await fetch(`{{ url('/master-catatan-rekomendasi/delete/') }}/${id}`, {
                        method: 'POST',
                        header: {
