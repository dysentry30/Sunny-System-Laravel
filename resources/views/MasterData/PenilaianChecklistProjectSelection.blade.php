...
{{-- Begin::Title --}}
@section('title', 'Kriteria Penilaian Checklist Project Selection')
{{-- End::Title --}}
...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Kriteria Penilaian Checklist Project Selection 
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            @if (auth()->user()->check_administrator || str_contains(auth()->user()->name, "(PIC)"))
                                ...
                                <div class="d-flex align-items-center py-1">
                                    ...
                                    <a  href="#" data-bs-target="#kt_modal_create_penilaian_pengguna_jasa" data-bs-toggle="modal" class="btn btn-sm btn-primary py-3"
                                        ...
                                        Tambah Penilaian Project Selection</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="d-flex justify-content-center">
                                                    <a href="#" data-bs-target="#kt_modal_create_penilaian_project_selection_{{$item->id }}" data-bs-toggle="modal" class="btn btn-sm btn-primary text-white" style="background-color: #008CB4;">Edit</a>
        ...
        <div class="modal-dialog modal-dialog-centered mw-600px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Tambah Kriteria Penilaian Checklist Project Selection</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <form action="/penilaian-checklist-project-selection/save" method="POST">
                    @csrf
                            ...
                            {{-- <div class="row mb-7">
                               ...
                               <div class="d-flex flex-row gap-2">
                                   ...
                                   <select id="nota_rekomendasi" name="nota_rekomendasi"
                                       ...
                                       data-select2-id="select2-nota" tabindex="-1" aria-hidden="true">
                                       <option value="" selected></option>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="d-flex flex-row gap-2">
                                        ...
                                        <select id="nama" name="nama"
                                            class="form-select form-select-solid select2-hidden-accessible"
                                            data-control="select2" data-hide-search="true" data-placeholder="Pilh Kategori..."
    ...
    @foreach ($data as $item)
        <div class="modal fade" id="kt_modal_create_penilaian_project_selection_{{ $item->id }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-600px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2>Edit Kriteria Penilaian Checklist Project Selection</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <form action="/penilaian-checklist-project-selection/update/{{ $item->id }}" method="POST">
                        @csrf
                        <input type="hidden" name="modal" value="kt_modal_create_otomasi_approval">
                        <!--begin::Modal body-->
                        <div class="modal-body py-lg-6 px-lg-6">
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                try {
                    ...
                    const req = await fetch(`{{ url('/penilaian-checklist-project-selection/delete/') }}/${id}`, {
                        method: 'POST',
                        header: {
