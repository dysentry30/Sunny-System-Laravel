...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Master LQ Rank
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            @canany(['super-admin', 'risk-crm'])
                                ...
                                <div class="d-flex align-items-center py-1">
                                    ...
                                    <!--begin::Button-->
                                    <a href="#" data-bs-target="#kt_modal_create_lq_rank"
    ...
    <div class="modal fade" id="kt_modal_create_lq_rank" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-600px">
            ...
            <div class="modal-content">
                ...
                <form action="/master-lq-rank/save" method="POST">
                    @csrf
    ...
    @foreach ($data as $lq)
        <div class="modal fade" id="kt_modal_edit_lq_rank_{{ $lq->id }}" tabindex="-1"
            aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-600px">
                <!--begin::Modal content-->
                            ...
                            <div class="row fv-row">
                                ...
                                <div class="">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="d-flex flex-row gap-2">
                                            <!--begin::Input-->
                                            <select id="nama_pelanggan_{{ $lq->id }}" name="nama_pelanggan"
                                                class="form-select form-select-solid" data-hide-search="false" data-placeholder="Pilh Pelanggan..." aria-hidden="true">
                                                <option value="" selected></option>
                                                @foreach ($customer as $pelanggan)
                                                    <option value="{{ $pelanggan->id_customer }}" {{ $pelanggan->id_customer == $lq->id_pelanggan ? 'selected' : '' }}>{{ $pelanggan->name }}</option>
                                                @endforeach
                                            </select>
                                            {{-- <input type="text" name="nama_pelanggan"
                                                class="form-control form-control-solid"
...
@section('js-script')
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        const req = await fetch(`{{ url('/master-lq-rank/${id}/delete') }}`, {
                            method: 'POST',
                            header: {
    ...
    <script>
        function showModal(id) {
            let modal = document.getElementById('kt_modal_edit_lq_rank_' + id);
            $(modal).modal('show');
    ...
    <script>
        $(document).ready(function(){
            $("#nama_pelanggan").select2({
                dropdownParent: $("#kt_modal_create_lq_rank")
            });
        })
    </script>
@endsection
