...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Jenis Proyek
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-2" id="kt_customers_table">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-auto text-center">Jenis Kode</th>
                                        @if (auth()->user()->check_administrator)
                                    ...
                                    @foreach ($jenis as $j)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                data-bs-target="#kt_edit_{{ $j->id }}"
                                                class="text-gray-600 text-gray text-hover-primary">{{ $j->jenis_proyek }}</a>
                                                </a>
                                            </td>
                                            <!--end::Nama Company-->
                                            ...
                                            @if (auth()->user()->check_administrator)
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    {{-- <button data-bs-toggle="modal"
                                                        data-bs-target="#kt_modal_delete{{ $j->id }}"
                                                        id="modal-delete"
    ...
    <!--begin::modal DELETE-->
    @foreach ($jenis as $j)
        <form action="/jenis-proyek/delete/{{ $j->id }}" method="post" enctype="multipart/form-data">
            @method('delete')
            @csrf
            <div class="modal fade" id="kt_modal_delete{{ $j->id }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
