...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Direktorat
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            @if (auth()->user()->check_administrator || str_contains(auth()->user()->name, "(PIC)"))
                                ...
                                <div class="d-flex align-items-center py-1">
                                    ...
                                    <!--begin::Button-->
                                    <a href="#" class="btn btn-sm btn-primary p-3" data-bs-toggle="modal"
                                            ...
                                            @if (auth()->user()->check_administrator)
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button data-bs-toggle="modal"
                                                        data-bs-target="#kt_modal_delete{{ $direktorat->id_direktorat }}"
                                                        id="modal-delete"
    ...
    <!--begin::Modal-->
    <form action="/direktorat/save" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <!--begin::Modal EDIT-->
    @foreach ($direktorat_all as $direktorat)
        <form action="/direktorat/{{ $direktorat->id_direktorat }}/save" method="post" enctype="multipart/form-data">
            @csrf
            <!--begin::Modal - Create Proyek-->
            <div class="modal fade" id="kt_edit_{{ $direktorat->id_direktorat }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog modal-dialog-centered mw-800px">
                    <!--begin::Modal content-->
                    <div class="modal-content">
    ...
    <!--begin::modal DELETE-->
    @foreach ($direktorat_all as $direktorat)
        <form action="/direktorat/{{ $direktorat->id_direktorat }}/delete" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal fade" id="kt_modal_delete{{ $direktorat->id_direktorat }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
