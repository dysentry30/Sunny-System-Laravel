...
{{-- Begin::Title --}}
@section('title', 'Master Klasifikasi Proyek')
{{-- End::Title --}}
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Master Klasifikasi Proyek 
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-600px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Tambah Klasifikasi Proyek</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <form action="/master-klasifikasi-proyek/save" method="POST">
                    @csrf
        ...
        <div class="modal fade" id="kt_modal_edit_klasifikasi_{{ $item->id }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-600px">
                ...
                <div class="modal-content">
                    ...
                    <form action="/master-klasifikasi-proyek/update/{{ $item->id }}" method="POST">
                        @csrf
                        <input type="hidden" name="modal" value="kt_modal_create_otomasi_approval">
                        <!--begin::Modal body-->
                        <div class="modal-body py-lg-6 px-lg-6">
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                try {
                    ...
                    const req = await fetch(`{{ url('/master-klasifikasi-proyek/delete/') }}/${id}`, {
                        method: 'POST',
                        header: {
