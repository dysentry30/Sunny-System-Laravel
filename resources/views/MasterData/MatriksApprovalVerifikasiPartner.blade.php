...
{{-- Begin::Title --}}
@section('title', 'Matriks Approval Verifikasi Partner')
{{-- End::Title --}}
...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Matriks Approval Verifikasi Partner
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-800px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Tambah Matriks Approval Verifikasi Partner</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <form action="/matriks-approval-varifikasi-partner/save" method="POST">
                    @csrf
        ...
        <div class="modal fade" id="kt_modal_edit_{{ $approval->id }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-800px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2>Edit Matriks Approval Verifikasi Partner</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <form action="/matriks-approval-varifikasi-partner/update" method="POST">
                        @csrf
    ...
    <!--begin::modal DELETE-->
    @foreach ($matriks_all as $approval)
        <form action="/matriks-approval-varifikasi-partner/delete" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id-matriks-approval" value="{{$approval->id}}">
