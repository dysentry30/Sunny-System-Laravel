...
@section('content')
                            ...
                            <div class="card-title">
                                ...
                                <form action="" class="d-flex flex-row w-auto" method="get">
                                    ...
                                    <select id="column" name="column"
                                        ...
                                        <option value="dop" {{ $column == 'dop' ? 'selected' : '' }}>Nama DOP</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" data-bs-toggle="modal"
                                                    data-bs-target="#kt_edit_{{ $dop->id }}"
                                                    class="text-gray-600 text-gray text-hover-primary">{{ $dop->dop }}</a>
                                                </a>
                                            </td>
                                            <!--end::Nama Company=-->
                                            ...
                                            @if (auth()->user()->check_administrator)
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button data-bs-toggle="modal"
                                                        data-bs-target="#kt_modal_delete{{ $dop->id }}"
                                                        id="modal-delete"
                            ...
                            <div class="">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-solid" id="dop"
                                        name="dop" value="" placeholder="DOP" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
    ...
    <!--begin::Modal EDIT-->
    @foreach ($dops as $dop)
    <form action="/dop/{{ $dop->id }}/save" method="post" enctype="multipart/form-data">
    @csrf
        <!--begin::Modal - Create Proyek-->
        <div class="modal fade" id="kt_edit_{{ $dop->id }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-800px">
                <!--begin::Modal content-->
                <div class="modal-content">
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" id="dop"
                                        name="dop" value="{{ $dop->dop }}" placeholder="DOP" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
    ...
    <!--begin::modal DELETE-->
    @foreach ($dops as $dop)
        <form action="/dop/delete/{{ $dop->id }}" method="post" enctype="multipart/form-data">
            @method('delete')
            @csrf
            <div class="modal fade" id="kt_modal_delete{{ $dop->id }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
