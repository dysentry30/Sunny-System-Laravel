                                ...
                                @foreach ($teams as $teamProyek)
                                    <tbody class="fw-bold text-gray-600">
                                        <tr>
                                            ...
                                            <!--begin::Nama Proyek=-->
                                            <td>
                                                <a href="/proyek/view/{{ $teamProyek->kode_proyek }}"
                                                    class="text-hover-primary text-gray-500">{{ $teamProyek->Proyek->nama_proyek }}</a>
                                            </td>
                                            <!--end::Nama Proyek=-->
                                            <!--begin::Nama Proyek=-->
                                            <td>
                                                <a href="/proyek/view/{{ $teamProyek->kode_proyek }}"
                                                    class="text-hover-primary text-gray-500">{{ $teamProyek->kode_proyek }}</a>
                                            </td>
                                            <!--end::Nama Proyek=-->
