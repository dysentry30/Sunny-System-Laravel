...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Tipe Proyek
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            <div class="card-title">
                                ...
                                <form action="" class="d-flex flex-row w-auto" method="get">
                                    ...
                                    <select id="column" name="column"
                                        ...
                                        <option value="mata_uang" {{ $column == 'mata_uang' ? 'selected' : '' }}>Tipe Proyek</option>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-2" id="kt_customers_table">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-auto text-center">tipe Kode</th>
                                        @if (auth()->user()->check_administrator)
                                    ...
                                    @foreach ($tipe as $t)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                data-bs-target="#kt_edit_{{ $t->id }}"
                                                class="text-gray-600 text-gray text-hover-primary">{{ $t->tipe_proyek }}</a>
                                                </a>
                                            </td>
                                            <!--end::Nama Company-->
                                            ...
                                            @if (auth()->user()->check_administrator)
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    {{-- <button data-bs-toggle="modal"
                                                        data-bs-target="#kt_modal_delete{{ $t->id }}"
                                                        id="modal-delete"
    ...
    <!--begin::Modal-->
    <form action="/tipe-proyek/save" method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" id="tipe-proyek"
                                        name="tipe-proyek" value="" placeholder="Tipe Proyek" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
                            ...
                            <div class="">
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold form-label mt-3">
                                        <span class="">Tipe Kode</span>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" id="tipe-proyek"
                                        name="tipe-kode" value="" placeholder="tipe-kode" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
    ...
    {{-- <!--begin::Modal EDIT-->
    @foreach ($ts as $t)
    <form action="/dop/{{ $t->id }}/save" method="post" enctype="multipart/form-data">
    @csrf
        <!--begin::Modal - Create Proyek-->
        <div class="modal fade" id="kt_edit_{{ $t->id }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-800px">
                <!--begin::Modal content-->
                <div class="modal-content">
                            ...
                            <div class="">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-solid" id="dop"
                                        name="dop" value="{{ $t->dop }}" placeholder="DOP" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                            </div>
    ...
    <!--begin::modal DELETE-->
    @foreach ($tipe as $t)
        <form action="/tipe-proyek/delete/{{ $t->id }}" method="post" enctype="multipart/form-data">
            @method('delete')
            @csrf
            <div class="modal fade" id="kt_modal_delete{{ $t->id }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
