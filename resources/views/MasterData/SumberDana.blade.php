								...
								<div class="row fv-row">
									...
									<div class="col-6">
										...
										<div class="fv-row mb-7">
											...
											<!--begin::Input-->
											<input type="text" class="form-control form-control-solid" 
											id="jenis-perusahaan" name="jenis-perusahaan" value="" placeholder="Jenis Perusahaan" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
									</div>
								...
								<div class="row fv-row">
									...
									<div class="col-6">
										...
										<div class="fv-row mb-7">
											...
											<!--begin::Input-->
											<input type="text" class="form-control form-control-solid" 
											id="tipe-lain" name="tipe-lain" value="" placeholder="Tipe Lain" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
									</div>
									...
									<div class="col-6">
										...
										<div class="fv-row mb-7">
											...
											<!--begin::Input-->
											<input type="text" class="form-control form-control-solid" 
											id="kode-sumber" name="kode-sumber" value="" placeholder="Kode" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
									</div>
								...
								<div class="row fv-row">
									...
									<div class="col-6">
										...
										<div class="fv-row mb-7">
											...
											<!--begin::Input-->
											<input type="text" class="form-control form-control-solid" 
											id="sumber-dana-id" name="sumber-dana-id" value="" placeholder="Sumber Dana ID" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
									</div>
									...
									<div class="col-6">
										...
										<div class="fv-row mb-7">
											...
											<!--begin::Input-->
											<input type="text" class="form-control form-control-solid" 
											id="kode-proyek-id" name="kode-proyek-id" value="" placeholder="Kode Proyek ID" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
									</div>
								...
								<div class="row fv-row">
									...
									<div class="col-6">
										...
										<div class="fv-row mb-7">
											...
											id="tipe-perusahaan" name="tipe-perusahaan" value="" placeholder="Tipe Perusahaan" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
									</div>
									...
									<div class="col-6">
										...
										<div class="fv-row mb-7">
											...
											<!--begin::Input-->
											<input type="text" class="form-control form-control-solid reformat" 
											id="cot-id" name="cot-id" value="" placeholder="COT ID" />
											<!--end::Input-->
										</div>
										<!--end::Input group-->
									</div>
