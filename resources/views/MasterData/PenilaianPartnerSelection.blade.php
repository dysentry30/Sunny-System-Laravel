...
{{-- Begin::Title --}}
@section('title', 'Kriteria Penilaian Partner Selection')
{{-- End::Title --}}
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Kriteria Penilaian Partner Selection 
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-600px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2>Tambah Kriteria Penilaian Partner Selection</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                ...
                <form action="/penilaian-partner-selection/save" method="POST">
                    @csrf
        ...
        <div class="modal fade" id="kt_modal_create_penilaian_pengguna_jasa_{{ $item->id }}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-600px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <!--begin::Modal title-->
                        <h2>Edit Kriteria Penilaian Partner Selection</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                        <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                    ...
                    <form action="/penilaian-partner-selection/update/{{ $item->id }}" method="POST">
                        @csrf
                        <input type="hidden" name="modal" value="kt_modal_create_otomasi_approval">
                        <!--begin::Modal body-->
                        <div class="modal-body py-lg-6 px-lg-6">
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                try {
                    ...
                    const req = await fetch(`{{ url('/penilaian-partner-selection/delete/') }}/${id}`, {
                        method: 'POST',
                        header: {
