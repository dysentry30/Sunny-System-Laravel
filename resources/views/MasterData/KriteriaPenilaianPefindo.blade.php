...
{{-- Begin::Title --}}
@section('title', 'Kriteria Penilaian Pefindo')
{{-- End::Title --}}
...
@section('content')
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex align-items-center fs-3 my-1">Kriteria Penilaian Pefindo 
                                </h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
                            ...
                            @if (auth()->user()->check_administrator || str_contains(auth()->user()->name, "(PIC)"))
                                ...
                                <div class="d-flex align-items-center py-1">
                                    ...
                                    <!--begin::Button-->
                                    <a  href="#" data-bs-target="#kt_modal_create_penilaian_pefindo" data-bs-toggle="modal" class="btn btn-sm btn-primary py-3"
                                        style="background-color:#008CB4; padding: 6px">
                                        Tambah Penilaian Pefindo</a>
                            ...
                            <table class="table align-middle table-bordered border-dark fs-6 gy-2" id="example">
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0 bg-primary">
                                        ...
                                        <th class="min-w-auto text-white">Probability of Default</th>
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    @foreach ($data as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">{{ $item->probability_of_default }}</td>
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="d-flex justify-content-center">
                                                    <a href="#" data-bs-target="#kt_modal_create_penilaian_pefindo_{{$item->id }}" data-bs-toggle="modal" class="btn btn-sm btn-primary text-white" style="background-color: #008CB4;">Edit</a>
    ...
    <div class="modal fade" id="kt_modal_create_penilaian_pefindo" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-600px">
            ...
            <div class="modal-content">
                ...
                <form action="/kriteria-penilaian-pefindo/save" method="POST">
                    @csrf
                    <input type="hidden" name="modal" value="kt_modal_create_penilaian_pefindo">
                    <!--begin::Modal body-->
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="row mb-7">
                                ...
                                <input type="text" name="grade" class="form-control form-control-solid">
                            </div>
                            ...
                            <div class="">
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="fs-6 fw-bold form-label mt-3">
                                        <span class="required">Risiko</span>
                                    </label>
                                    <!--end::Label-->
                                    <div class="d-flex flex-row gap-2">
                                        <!--begin::Input-->
                                        <select id="nama" name="nama"
                                            class="form-select form-select-solid select2-hidden-accessible"
                                            data-control="select2" data-hide-search="true" data-placeholder="Pilh Risiko..."
                            ...
                            <div class="row mb-7">
                                <label class="fs-6 fw-bold form-label mt-3">
                                    <span class="required">Probability of Default</span>
                                </label>
                                <input type="text" name="probability_of_default" class="form-control form-control-solid">
                            </div>
    ...
    @foreach ($data as $item)
        <div class="modal fade" id="kt_modal_create_penilaian_pefindo_{{ $item->id }}" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-600px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <form action="/kriteria-penilaian-pefindo/update/{{ $item->id }}" method="POST">
                        @csrf
                        ...
                        <div class="modal-body py-lg-6 px-lg-6">
                            ...
                            <div class="row fv-row">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <input type="text" name="grade" value="{{ $item->grade }}" class="form-control form-control-solid">
                                </div>
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="d-flex flex-row gap-2">
                                            ...
                                            <select id="nama" name="nama"
                                                class="form-select form-select-solid select2-hidden-accessible"
                                                data-control="select2" data-hide-search="true" data-placeholder="Pilh Risiko..."
                                                data-select2-id="select2-risiko-{{ $item->id }}" tabindex="-1" aria-hidden="true">
                                                <option value="" selected></option>
                                                <option value="Very Low Risk" {{ $item->nama == "Very Low Risk" ? 'selected' : '' }}>Very Low Risk</option>
                                                <option value="Low Risk" {{ $item->nama == "Low Risk" ? 'selected' : '' }}>Low Risk</option>
                                                <option value="Average Risk" {{ $item->nama == "Average Risk" ? 'selected' : '' }}>Average Risk</option>
                                                <option value="High Risk" {{ $item->nama == "High Risk" ? 'selected' : '' }}>High Risk</option>
                                                <option value="Very High Risk" {{ $item->nama == "Very High Risk" ? 'selected' : '' }}>Very High Risk</option>
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-7">
                                    ...
                                    <input type="text" name="probability_of_default" value="{{ $item->probability_of_default }}" class="form-control form-control-solid">
                                </div>
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                try {
                    ...
                    const req = await fetch(`{{ url('/kriteria-penilaian-pefindo/delete/') }}/${id}`, {
                        method: 'POST',
                        header: {
