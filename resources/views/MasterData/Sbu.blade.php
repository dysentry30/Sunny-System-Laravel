                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a data-bs-toggle="modal"
                                                    data-bs-target="#kt_modal_edit_{{ $sbu->id }}" id="click-no"
                            ...
                            <div class="col-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select id="klasifikasi" name="klasifikasi" class="form-select form-select-solid"
                                        ...
                                        <option value="Bangun Gedung"
                                            {{ old('klasifikasi') == 'Bangun Gedung' ? 'selected' : '' }}>Bangun Gedung
                                        </option>
                                        <option value="Kontruksi manufaktur"
                                            {{ old('klasifikasi') == 'Kontruksi manufaktur' ? 'selected' : '' }}>Kontruksi
                                            manufaktur</option>
                                        <option value="Minyak dan Gas"
                                            {{ old('klasifikasi') == 'Minyak dan Gas' ? 'selected' : '' }}>Minyak dan Gas
                                        </option>
                                        <option value="Sumber Daya Air"
                                            {{ old('klasifikasi') == 'Sumber Daya Air' ? 'selected' : '' }}>Sumber Daya Air
                                        </option>
            ...
            <div class="modal fade" id="kt_modal_edit_{{ $sbu->id }}" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-centered mw-800px">
                    ...
                    <div class="modal-content">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-solid" id="edit-lingkup"
                                            name="edit-lingkup" value="{{ $sbu->lingkup_kerja }}"
                                            placehoedit-lder="Lingkup Pekerjaan" />
                                        @error('edit-lingkup')
                                            <h6 class="text-danger fw-normal">{{ $message }}</h6>
                                        @enderror
                                        <!--end::Input-->
                            ...
                            <div class="row fv-row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select id="edit-klasifikasi" name="edit-klasifikasi"
                                            class="form-select form-select-solid" data-control="select2"
                                            data-hide-search="true" data-placeholder="Klasifikasi">
                                            <option selected></option>
                                            <option value="Bangun Gedung"
                                                {{ $sbu->klasifikasi == 'Bangun Gedung' ? 'selected' : '' }}>Bangun Gedung
                                            </option>
                                            <option value="Kontruksi manufaktur"
                                                {{ $sbu->klasifikasi == 'Kontruksi manufaktur' ? 'selected' : '' }}>
                                                Kontruksi manufaktur</option>
                                            <option value="Minyak dan Gas"
                                                {{ $sbu->klasifikasi == 'Minyak dan Gas' ? 'selected' : '' }}>Minyak dan
                                                Gas</option>
                                            <option value="Sumber Daya Air"
                                                {{ $sbu->klasifikasi == 'Sumber Daya Air' ? 'selected' : '' }}>Sumber Daya
                                                Air</option>
                                            <option value="Transportasi"
                                                {{ $sbu->klasifikasi == 'Transportasi' ? 'selected' : '' }}>Transportasi
                                            </option>
                                        </select>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-solid"
                                            id="edit-sub-klasifikasi" name="edit-sub-klasifikasi"
                                            value="{{ $sbu->sub_klasifikasi }}" placeholder="Sub-Klasifikasi" />
                            ...
                            <div class="row fv-row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid"
                                            id="edit-referensi1" name="edit-referensi1" value="{{ $sbu->referensi1 }}"
                                            placeholder="Referensi 1" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
                            ...
                            <div class="row fv-row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid"
                                            id="edit-referensi2" name="edit-referensi2" value="{{ $sbu->referensi1 }}"
                                            placeholder="Referensi 2" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid"
                                            id="edit-referensi3" name="edit-referensi3" value="{{ $sbu->referensi1 }}"
                                            placeholder="Referensi 3" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" id="new_save"
