                        ...
                        <div class="toolbar" id="kt_toolbar">
                            ...
                            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                                ...
                                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                    ...
                                    <!--begin::Title-->
                                    <h1 class="d-flex align-items-center fs-3 my-1">Buat User
                                    </h1>
                                    <!--end::Title-->
                                </div>
                                <!--end::Page title-->
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <div class="d-flex align-items-center position-relative my-1">
                                                            ...
                                                            <input type="text" id="nip" name="nip"
                                                                class="form-control form-control-solid ps-12" value="{{ old("nip") }}"
                                                                placeholder="NIP" />
                                                        </div>
                                                        @error('nip')
                                                        ...
                                                        <div class="d-flex flex-column h-150px justify-content-between">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="" name="administrator" id="administrator">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="" name="user-sales" id="user-sales">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="" name="team-proyek" id="team-proyek">
