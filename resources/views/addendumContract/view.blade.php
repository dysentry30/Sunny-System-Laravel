...
@section('content')
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    @if (empty($addendumContract))
                        ...
                        @else
                            <form action="/addendum-contract/update" method="post" enctype="multipart/form-data">
                                <input type="hidden" value="{{ $addendumContract->id_addendum ?? old('id-addendum') }}"
                                    name="id-addendum">
                    @endif
                    @csrf
                    {{-- begin::input --}}
                    ...
                    <div class="post d-flex flex-column-fluid" id="kt_post">
                        ...
                        <div id="kt_content_container" class="container-fluid">
                            ...
                            <div class="toast align-items-center text-bg-primary border-0 position-relative end-0 top-0 my-5"
                                        ...
                                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                            ...
                                            <div class="card-body pt-5">
                                                ...
                                                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <a class="nav-link text-active-primary pb-4 active"
                                                            data-bs-toggle="tab" href="#kt_user_view_overview_attachment"
                                                            style="font-size:14px;" aria-selected="false" role="tab"
                                                            stage="1">Draft</a>
                                                    </li>
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                                ...
                                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                                    ...
                                                                    <thead>
                                                                        ...
                                                                        <tr
                                                                            ...
                                                                            <th class="min-w-125px">Dokumen Draft Proposal
                                                                                Addendum</th>
                                                                    ...
                                                                    <tbody class="fw-bold text-gray-600">
                                                                        @foreach ($addendumContract->addendumContractDrafts as $key => $draft_addendum)
                                                                            <tr>
                                                                                <td class="text-gray-600">{{ $key + 1 }}
                                                                                </td>
                                                                                <td class="text-gray-600">
                                                                                    {{ $draft_addendum->uraian_perubahan }}
                                                                                </td>
                                                                                <td class="text-gray-600">
                                                                                    <a target="_blank"
                                                                                        class="text-hover-primary"
                                                                                        href="/document/view/{{ $draft_addendum->id_addendum_draft }}/{{ $draft_addendum->id_document_instruksi }}">{{ $draft_addendum->id_document_instruksi }}</a>
                                                                                </td>
                                                                                ...
                                                                                <td class="text-gray-600">
                                                                                    <a target="_blank"
                                                                                        class="text-hover-primary"
                                                                                        href="/document/view/{{ $draft_addendum->id_addendum_draft }}/{{ $draft_addendum->id_document_draft_proposal_addendum }}">{{ $draft_addendum->id_document_draft_proposal_addendum }}</a>
                                                                                </td>
                                                                                ...
                                                                                <td
                                                                                    class="text-gray-600 min-w-100px text-break">
                                                                                ...
                                                                                <td
                                                                                    ...
                                                                                    @foreach ($list_dokumen as $key => $dokumen_pendukung)
                                                                                        - <a target="_blank"
                                                                                            class="text-hover-primary"
                                                                                            href="/document/view/{{ $draft_addendum->id_addendum_draft }}/{{ $dokumen_pendukung }}">Dokumen
                                                                                            {{ $key + 1 }}</a> <br>
                                                                                    @endforeach
                                                                                </td>
                                                        ...
                                                        <div class="card-title m-0">
                                                            ...
                                                            <div class="fv-row mb-5">
                                                                <h3 class="fw-bolder m-0" id="HeadDetail"
                                                                    ...
                                                                    <a href="#" data-bs-toggle="modal"
                                                                        data-bs-target="#kt_modal_diajukan"
                                                                        id="Plus">+</a>
                                                                </h3>
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-gray-600">
                                                                                    <a class="text-gray-600 text-hover-primary"
                                                                                        target="_blank"
                                                                                        href="/document/view/{{ $draft_addendum->id_addendum_contract_diajukan }}/{{ $draft_addendum->id_document_proposal_addendum }}">{{ $draft_addendum->id_document_proposal_addendum }}</a>
                                                                                </td>
                                                                                ...
                                                                                <td
                                                                                    ...
                                                                                    @foreach ($list_dokumen as $key => $dokumen_pendukung)
                                                                                        - <a class="text-gray-600 text-hover-primary"
                                                                                            target="_blank"
                                                                                            href="/document/view/{{ $draft_addendum->id_addendum_contract_diajukan }}/{{ $dokumen_pendukung }}">Dokumen
                                                                                            {{ $key + 1 }}</a> <br>
                                                                                    @endforeach
                                                                                </td>
                                                                            </tr>
                                                        ...
                                                        <div class="card-title m-0">
                                                            ...
                                                            <div class="fv-row mb-5">
                                                                <h3 class="fw-bolder m-0" id="HeadDetail"
                                                                    ...
                                                                    <a href="#" data-bs-toggle="modal"
                                                                        data-bs-target="#kt_modal_Negoisasi"
                                                                        id="Plus">+</a>
                                                                </h3>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <p class="text-gray-600">
                                                                                        {{ $draft_addendum->uraian_activity }}
                                                                                    </p>
                                                                                </td>
                                                        ...
                                                        <div class="card-title m-0">
                                                            ...
                                                            <div class="fv-row mb-5">
                                                                <h3 class="fw-bolder m-0" id="HeadDetail"
                                                                    ...
                                                                    <a href="#" data-bs-toggle="modal"
                                                                        data-bs-target="#kt_modal_disetujui"
                                                                        id="Plus">+</a>
                                                                </h3>
                                                                ...
                                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                                    ...
                                                                    <thead>
                                                                        ...
                                                                        <tr
                                                                            class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                                            <th class="min-w-125px">Dokumen Surat Disetujui
                                                                            </th>
                                                                    ...
                                                                    <tbody class="fw-bold text-gray-600">
                                                                        @foreach ($addendumContract->addendumContractDisetujui as $key => $draft_addendum)
                                                                            <tr>
                                                                                ...
                                                                                <td class="text-gray-600">
                                                                                    {{ $draft_addendum->waktu_eot_disetujui }}
                                                                                </td>
                                                                                ...
                                                                                <td class="min-w-100px text-break">
                                                                                    ...
                                                                                    @foreach ($list_dokumen as $key => $dokumen_pendukung)
                                                                                        - <a target="_blank"
                                                                                            class="text-gray-600 text-hover-primary"
                                                                                            href="/document/view/{{ $draft_addendum->id_addendum_contract_disetujui }}/{{ $dokumen_pendukung }}">Dokumen
                                                                                            {{ $key + 1 }}</a> <br>
                                                                                    @endforeach
                                                                                </td>
                                                                            </tr>
                                                    ...
                                                    <div class="tab-pane fade" id="kt_user_amandemen" role="tabpanel">
                                                        ...
                                                        <div class="card-title m-0">
                                                            ...
                                                            <div class="fv-row mb-5">
                                                                <h3 class="fw-bolder m-0" id="HeadDetail"
                                                                    ...
                                                                    <a href="#" data-bs-toggle="modal"
                                                                        data-bs-target="#kt_modal_amandemen"
                                                                        id="Plus">+</a>
                                                                </h3>
                                                                        ...
                                                                        @foreach ($addendumContract->addendumContractAmandemen as $key => $draft_addendum)
                                                                            <tr>
                                                                                <td>
                                                                                    <a target="_blank"
                                                                                        class="text-gray-600 text-hover-primary"
                                                                                        href="/document/view/{{ $draft_addendum->id_addendum_contract_amandemen }}/{{ $draft_addendum->id_dokumen_amandemen }}">{{ $draft_addendum->id_dokumen_amandemen }}</a>
                                                                                </td>
                                                                                ...
                                                                                <td
                                                                                    ...
                                                                                    @foreach ($list_dokumen as $key => $dokumen_pendukung)
                                                                                        - <a target="_blank"
                                                                                            href="/document/view/{{ $draft_addendum->id_addendum_contract_amandemen }}/{{ $dokumen_pendukung }}">Dokumen
                                                                                            {{ $key + 1 }}</a> <br>
                                                                                    @endforeach
                                                                                </td>
                                                                            </tr>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-2">
                                                                        <h3 class="fw-bolder m-0" id="HeadDetail"
                                                                            style="font-size:14px;">
                                                                            Draft
                                                                            <a href="#" data-bs-target="#kt_modal_draft"
                                                                                data-bs-toggle="modal" id="Plus">+</a>
                                                                        </h3>
                                                                    </div>
                                                                </div>
                                                                <div class="fv-row mb-7">
                ...
                <form action="/addendum-contract/draft/upload" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <div class="fv-row mb-5">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="uraian-perubahan" class="form-label fs-6 fw-normal">Uraian
                                        Perubahan</label>
                                    <textarea rows="3" placeholder="Input Perubahan" name="uraian-perubahan"
                                        class="form-control form-control-solid"></textarea>
                                </div>
                                <div class="col-6">
                                    <label for="surat-instruksi" class="form-label fs-6 fw-normal">Surat / Instruksi (Dari
                                        Owner)</label>
                                ...
                                <div class="col-6">
                                    <div class="d-flex flex-row">
                                        <button type="button" onclick="showModalPasal()" role="button"
                                            class="btn btn-sm btn-link text-dark fs-6 fw-normal">Pasal-pasal<i
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="pengajuan-waktu" class="form-label fs-6 fw-normal">Pengajuan Waktu / EOT
                                    </label>
                                    <a href="#" class="btn btn-sm mx-3"
                                        ...
                                        onclick="showCalendarModal(this)" data-target="EOT"><i
                                            class="bi bi-calendar2-plus-fill d-flex justify-content-center align-items-center"
                                            style="color: #008cb4"></i></a>
                                    <input type="date" name="pengajuan-waktu" id="pengajuan-waktu"
                                        class="form-control form-control-solid">
                                </div>
                                <div class="col-6">
                                    <label for="draft-proposal-addendum" class="form-label fs-6 fw-normal">Draft Proposal
                                        Addendum</label>
                                    <input type="file" name="draft-proposal-addendum" accept=".docx"
                                        class="form-control form-control-solid fw-normal">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <select name="draft-rekomendasi" id="draft-rekomendasi" style="z-index: 9999999;"
                                        class="form-select form-select-solid" data-control="select2"
                                ...
                                <div class="col-6">
                                    <label for="uraian-rekomendasi" class="form-label fs-6 fw-normal">Uraian
                                        Rekomendasi</label>
                ...
                <form action="/addendum-contract/diajukan/upload" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <div class="fv-row mb-5">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="proposal-addendum" class="form-label fs-6 fw-normal">Proposal
                                        Addendum</label>
                                    <input type="file" accept=".docx" name="proposal-addendum"
                                        class="form-control form-control-solid fw-normal">
                                </div>
                                <div class="col-6">
                                    <label for="tanggal-diajukan" class="form-label fs-6 fw-normal">Tanggal
                                        Diajukan</label>
                                    <a href="#" class="btn btn-sm mx-3"
                                        style="background: transparent;width:.5rem;height:2.3rem;"
                                        onclick="showCalendarModal(this)" data-target="EOT"><i
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="diajukan-rekomendasi"
                                        class="form-label fs-6 fw-normal">Rekomendasi</label>
                    ...
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <div class="fv-row mb-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="tanggal-activity" class="form-label fs-6 fw-normal">Tanggal
                                        Activity</label>
                                    <a href="#" class="btn btn-sm mx-3"
                                        style="background: transparent;width:.5rem;height:2.3rem;"
                                        onclick="showCalendarModal(this)" data-target="EOT"><i
                ...
                <form action="/addendum-contract/disetujui/upload" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <div class="fv-row mb-5">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="surat-disetujui" class="form-label fs-6 fw-normal required">Surat
                                        Disetujui Dari Owner</label>
                                    <input type="file" accept=".docx" name="surat-disetujui"
                                        class="form-control form-control-solid fw-normal">
                                </div>
                                <div class="col-6">
                                    <label for="tanggal-disetujui" class="form-label fs-6 fw-normal required">Tanggal
                                        Disetujui</label>
                                    <a href="#" class="btn btn-sm mx-3"
                                        style="background: transparent;width:.5rem;height:2.3rem;"
                                        onclick="showCalendarModal(this)" data-target="EOT"><i
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="biaya-disetujui" class="form-label fs-6 fw-normal required">Biaya
                                        Disetujui</label>
                                    <input type="text" name="biaya-disetujui"
                                        class="form-control form-control-solid fw-normal">
                                </div>
                                <div class="col-6">
                                    <label for="waktu-eot-disetujui" class="form-label fs-6 fw-normal required">Waktu /
                                        EOT Disetujui</label>
                                    <a href="#" class="btn btn-sm mx-3"
                                        style="background: transparent;width:.5rem;height:2.3rem;"
                                        onclick="showCalendarModal(this)" data-target="EOT"><i
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="keterangan-disetujui"
                                        class="form-label fs-6 fw-normal required">Keterangan</label>
                                    <textarea rows="1" name="keterangan-disetujui" class="form-control form-control-solid fw-normal"></textarea>
                                </div>
                                <div class="col-6">
                                    <label for="dokumen-pendukung" class="form-label fs-6 fw-normal required">Dokumen
                                        Pendukung</label>
                                    <input type="file" name="dokumen-pendukung[]" accept=".docx,.xlsx,.pdf" multiple
                                        class="form-control form-control-solid">
                                </div>
                            </div>
                        </div>
                ...
                <form action="/addendum-contract/amandemen/upload" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <div class="fv-row mb-5">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <label for="dokumen-amandemen" class="form-label fs-6 fw-normal">Dokumen
                                        Amandemen</label>
                                    <input type="file" accept=".docx" name="dokumen-amandemen"
                                        class="form-control form-control-solid fw-normal">
                                </div>
                                <div class="col-6">
                                    <label for="tanggal-amandemen" class="form-label fs-6 fw-normal">Tanggal
                                        Amandemen</label>
                                    <a href="#" class="btn btn-sm mx-3"
                                        style="background: transparent;width:.5rem;height:2.3rem;"
                                        onclick="showCalendarModal(this)" data-target="EOT"><i
                                            class="bi bi-calendar2-plus-fill d-flex justify-content-center align-items-center"
                                            style="color: #008cb4"></i></a>
                                    <input type="date" name="tanggal-amandemen"
                                        class="form-control form-control-solid">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" name="biaya-amandemen"
                                        class="form-control form-control-solid fw-normal">
                                </div>
                                <div class="col-6">
                                    <label for="waktu-eot-amandemen" class="form-label fs-6 fw-normal">Waktu / EOT
                                        Amandemen</label>
                                    <a href="#" class="btn btn-sm mx-3"
                                        style="background: transparent;width:.5rem;height:2.3rem;"
                                        onclick="showCalendarModal(this)" data-target="EOT"><i
                                            class="bi bi-calendar2-plus-fill d-flex justify-content-center align-items-center"
                                            style="color: #008cb4"></i></a>
                                    <input type="date" name="waktu-eot-amandemen"
                                        class="form-control form-control-solid">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-6">
                                    <label for="keterangan-amandemen"
                                        class="form-label fs-6 fw-normal">Keterangan</label>
                                    <textarea rows="1" name="keterangan-amandemen" class="form-control form-control-solid fw-normal"></textarea>
                                </div>
                                <div class="col-6">
                                    <label for="dokumen-pendukung" class="form-label fs-6 fw-normal">Dokumen
                                        Pendukung</label>
                                    <input type="file" name="dokumen-pendukung[]" accept=".docx,.xlsx,.pdf"
                                        multiple class="form-control form-control-solid">
                                </div>
                            </div>
                        </div>
                        <!--end::Input group-->
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col d-flex justify-content-end align-items-end">
                                <button class="btn btn-sm btn-active-primary" onclick="showModalPasalImport()"
                                    style="background-color: #e6e6e6">Import Pasal</button>
                            </div>
                        </div>
                    </div>
                    <!--end::Input group-->
    ...
    <div class="modal fade" id="kt_modal_calendar_start" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        <!--begin::Modal dialog-->
    ...
    <div class="modal fade" id="kt_modal_import_pasal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-900px">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <form action="/pasal/import" method="POST" enctype="multipart/form-data">
                    <div class="modal-body py-lg-6 px-lg-6">
                        ...
                        <input type="file" name="import-file-upload" accept=".xlsx"
                            class="form-control form-control-solid">
                    </div>
                    <!--end::Input group-->
                    <div class="modal-footer">
