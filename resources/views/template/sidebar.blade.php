            ...
            <div class="aside-menu flex-column-fluid" style="background-color:#0db0d9;margin-top:10px;">
                ...
                <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                    ...
                    <div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#0db0d9;">
                        ...
                        @canany(['super-admin', 'admin-crm', 'risk-crm'])
                            ...
                            <div class="collapse" id="manrisk-collapse">
                                ...
                                @canany(['super-admin', 'risk-crm'])
                                    <!--begin::Menu Colapse-->
                                    <div id="#kt_aside_menu" data-kt-menu="true"
                                        style="background-color:#0ca1c6; padding:8px 0px 8px 40px; {{ Request::Path() == 'masalah-hukum' ? 'background-color:#008CB4' : '' }}">
                                        <a class="menu-link d-flex flex-row align-items-center" href="/masalah-hukum"
                                            style="color:white; padding-left:10px;">
                                            <span class="menu-icon">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                {{-- <i class="bi bi-buildings text-white"></i>                                                     --}}
                        ...
                        @canany(['super-admin', 'admin-crm', 'user-crm', 'ska-skt'])
                            <!--begin::Menu Colapse-->
                            <div class="menu-item">
                        ...
                        @if (Auth::user()->email == "user-poc@sunny.com")
                            ...
                            <!--begin::Menu Colapse-->
                            <div class="menu-item">
                                <a class="menu-link " href="/estimasi-proyek"
                                    style="color:white; padding-left:20px; {{ Request::Path() == 'estimasi-proyek' ? 'background-color:#008CB4' : '' }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
