                                                                            ...
                                                                            @foreach ($dops as $dop)
                                                                                ...
                                                                                <tr style="text-align: right; ">
                                                                                    ...
                                                                                    <td class="pinForecast HidePin">
                                                                                        {{ number_format($total_ok_per_dop / $per_sejuta, 0, '.', '.') }}
                                                                                    </td>
                                                                                    <td class="pinForecast HidePin">
                                                                                        {{ number_format($total_forecast_per_dop / $per_sejuta, 0, '.', '.') }}
                                                                                    </td>
                                                                                    <td class="pinForecast HidePin">
                                                                                        {{ number_format($total_realisasi_per_dop / $per_sejuta, 0, '.', '.') }}
                                                                                    </td>
