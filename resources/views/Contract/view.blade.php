            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="kt_user_view_overview_Performance" role="tabpanel">
                    ...
                    <div class="card-title m-0">
                        ...
                        <h3 class="fw-bolder m-0" id="HeadDetail" style="font-size:14px;">
                            Change Request
                            <a href="/contract-management/view/{{ url_encode($contract->id_contract) }}/addendum-contract"
                                Id="Plus">+</a>
                        </h3>
                                ...
                                @if ($contract->RencanaKerjaManajemen->count() > 0)
                                    @forelse ($contract->RencanaKerjaManajemen as $key => $rencana_kerja)
                                        <tr>
                                            ...
                                            <!--begin::Name=-->
                                            <td>
                                                <pre class="text-gray-600 mb-1" style="font-family: 'BpmOpenSans-woff';">{!! $rencana_kerja->ketentuan_rencana_kerja !!}</pre>
                                            </td>
                                            <!--end::Name=-->
                                            <!--begin::Name=-->
                                            <td>
                                                <pre class="text-gray-600 mb-1" style="font-family: 'BpmOpenSans-woff';">{!! $rencana_kerja->informasi_lengkap_adkon !!}</pre>
                                            </td>
                                            <!--end::Name=-->
                                        </tr>
                                    @empty
                            ...
                            <tbody class="fw-bold text-gray-400">
                                @forelse ($contract->PasalKontraktual as $key => $ps)
                                    <tr>
                                        ...
                                        <!--begin::Name=-->
                                        <td>
                                            <pre class="text-gray-600 mb-1" style="font-family: 'BpmOpenSans-woff';">{!! $ps->item !!}</pre>
                                        </td>
                                        <!--end::Name=-->
                                        <!--begin::Name=-->
                                        <td>
                                            <pre class="text-gray-600 mb-1" style="font-family: 'BpmOpenSans-woff';">{!! $ps->pasal !!}</pre>
                                        </td>
                                        <!--end::Name=-->
                                        <!--begin::Name=-->
                                        <td>
                                            <pre class="text-gray-600 mb-1" style="font-family: 'BpmOpenSans-woff';">{!! $ps->perpanjangan_waktu !!}</pre>
                                        </td>
                                        <!--end::Name=-->
                                        <!--begin::Name=-->
                                        <td>
                                            <pre class="text-gray-600 mb-1" style="font-family: 'BpmOpenSans-woff';">{!! number_format($ps->tambahan_biaya, 0, ".", ".") !!}</pre>
                                        </td>
                                        <!--end::Name=-->
                                    </tr>
                                @empty
...
@if ($contract->stages >= 1)
    ...
    <!--begin::Modal - Perubahan Kontrak Menang-->
