            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
                ...
                <div class="aside-menu flex-column-fluid" style="background-color:#535353;margin-top:40px;">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                                ...
                                <a class="menu-link active" href="1_Dashboard.html" style="color:white;">
                                    <span class="menu-icon">
                                        ...
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/dashboards.svg"
                                                class="h-35px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="2_Customer.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/account.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="3_Proyek.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/opportunity.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="4_Contract.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/contract.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="5_Claim.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/releases.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="6_Document.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/documents.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="7_KPI.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/bonus_rules.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="8_Knowledge_Base.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/knowledge_base.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="9_Change_request.html" style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/changes.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                        ...
                        <div id="#kt_aside_menu" data-kt-menu="true" style="background-color:#535353;margin-top:8px;">
                            <div class="menu-item">
                                <a class="menu-link active" href="10_Stakeholder_Communication.html"
                                    style="color:white;">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <img alt="Logo" src="assets/media/icons/duotune/creatio/feed.svg"
                                                class="h-30px logo" />
                                        </span>
                                        <!--end::Svg Icon-->
                                    </span>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="post d-flex flex-column-fluid" id="kt_post">
                        ...
                        <div id="kt_content_container" class="container-xxl">
                            <img src="assets/media/demos/Coming-Soon-Illustration-01.svg" alt="development"
                                class="tengah" style="width:50%;" />
                        </div>
                    </div>
                    <!--end::Post-->
