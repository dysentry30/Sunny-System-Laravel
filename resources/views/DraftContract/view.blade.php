                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <a href="#kt_modal_calendar" class="btn"
                                                                ...
                                                                data-bs-target="#kt_modal_calendar" data-bs-toggle="modal">
                                                        ...
                                                        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8"
                                                            ...
                                                            <li class="nav-item" role="presentation">
                                                                <a class="nav-link text-active-primary pb-4"
                                                                    data-bs-toggle="tab"
                                                                    href="#kt_user_view_overview_pasal"
                                                                ...
                                                                <div class="card-title m-0">
                                                                    ...
                                                                    <div class="fv-row mb-5">
                                                                        ...
                                                                        <input type="file" style="font-weight: normal"
                                                                            ...
                                                                            name="attach-file-draft"
                                                                            id="attach-file-draft" value=""
                                                                        ...
                                                                        <label class="fs-6 fw-bold form-label mt-3">
                                                                            <span
                                                                                style="font-weight: normal">Catatan</span>
                                                                        </label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <input type="text" class="form-control form-control-solid"
                                                                ...
                                                                placeholder="Who create this draft?"
                                                                id="draft-contract-create-by" readonly
                                                                aria-readonly="true" name="draft-contract-create-by" />
                                                            @error('draft-contract-create-by')
                                                                <h6>
                                                                    <b style="color: rgb(209, 38, 38)">{{ $message }}</b>
                                                                </h6>
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <label
                                                        ...
                                                        <input class="form-check-input"
                                                            name="{{ $pasal->id_pasal ?? 0 }}" type="checkbox"
                                                            value="{{ $pasal->id_pasal ?? 0 }}" checked="true">
