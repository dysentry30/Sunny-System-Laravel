...
<body>
    ...
    <table style="width:100%; margin-left:20px">
        <tr style="margin:0; padding:0">
            ...
            <td style="width: 80%"><textarea id="catatan" cols="30" rows="10" style="border: 0px solid black; font-size:0.5rem; font-family: Arial, Helvetica, sans-serif; margin:0; padding: 0">{!! $proyek->pekerjaan_utama !!}</textarea></td>
        </tr>
        <tr style="margin:0; padding:0">
            <td style="width: 2%" valign="top">
                <p style="margin: 0; padding:0; font-size:0.5rem">2.</p>
    ...
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 80%"><p style="margin: 0; padding:0; font-size:0.5rem">Lorem ipsum dolor sit amet.</p></td>
    ...
    <table style="width: 100%; margin-left:20px">
        <tr>
            <td style="width: 2%"><p style="margin: 0; padding:0; font-size:0.5rem">1.</p></td>
            <td style="width: 17%"><p style="margin: 0; padding:0; font-size:0.5rem">Lorem, ipsum dolor.</p></td>
            {{-- <td style="width: 17%"></td> --}}
            <td style="width: 40%"></td>
            <td style="width: 30%"><p style="margin: 0; padding:0; font-size:0.5rem">20 %</p></td>
        </tr>
        <tr>
            <td style="width: 2%"><p style="margin: 0; padding:0; font-size:0.5rem">2.</p></td>
            <td style="width: 17%"><p style="margin: 0; padding:0; font-size:0.5rem">Lorem, ipsum dolor.</p></td>
    ...
    <table style="width: 100%; margin-left:10px">
        <tr>
            <td style="width:2%"></td>
            <td style="width:20%"><p style="margin: 0; padding:0; font-size:0.5rem">Nama Mitra KSO</p></td>
            <td style="width:30%"><p style="margin: 0; padding:0; font-size:0.5rem">Sudah Pernah ber-KSO dengan WIKA</p></td>
            <td style="width:20%" colspan="2"><p style="margin: 0; padding:0; font-size:0.5rem">Evaluasi Kinerja Mitra KSO</p></td>
        </tr>
        <tr>
            <td style="width:2%"></td>
            <td style="width:20%"></td>
            <td style="width:30%"></td>
            <td style="width:20%"><p style="margin: 0; padding:0; font-size:0.5rem">Kekuatan</p></td>
            <td style="width:20%"><p style="margin: 0; padding:0; font-size:0.5rem">Kelemahan</p></td>
        </tr>
        <!--Begin::Mitra 1-->
        <tr>
            <!--Nomor-->
            <td valign="top" style="width:2%"><p style="margin: 0; padding:0; font-size:0.5rem; text-align:start">1.</p></td>
            <!--Mitra KSO-->
            <td valign="top" style="width:20%"><p style="margin: 0; padding:0; font-size:0.5rem; text-align:start">Lorem ipsum dolor sit.</p></td>
            <!--Sudah / Belum-->
            <td valign="top" style="width:30%"><p style="margin: 0; padding:0; font-size:0.5rem; text-align:start">sudah / <s>belum</s> *</p></td>
            <!--Kekuatan-->
            <td style="width:20%">
                <table style="width: 100%">
                    <tr>
                        <td style="width: 2%"><p style="margin: 0; padding:0; font-size:0.5rem">1.</p></td>
                        <td style="width: 90%"><p style="margin: 0; padding:0; font-size:0.5rem">_____________________________</p></td>
                    </tr>
                    <tr>
                        <td style="width: 2%"><p style="margin: 0; padding:0; font-size:0.5rem">2.</p></td>
                        <td style="width: 90%"><p style="margin: 0; padding:0; font-size:0.5rem">_____________________________</p></td>
    ...
    <table style="width: 80%">
        ...
        <tr>
            <td style="width:2%"><p style="margin: 0; padding:0; font-size:0.5rem">2.</p></td>
            <td style="width:5%"><input type="checkbox" id="opsi-loan-2" {{ !empty($proyek->fasilitas_ncl) && str_contains($proyek->fasilitas_ncl, 'Diajukan untuk terbit masing-masing sesuai porsi ke Pengguna Jasa') ? 'checked' : '' }}></td>
    ...
    <p style="margin: 5px 0px 0px 0px; padding:0; font-size:0.5rem">Jakarta,....................</p>
