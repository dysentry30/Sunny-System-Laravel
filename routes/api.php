...
Route::middleware(["web"])->group(function () {
    ...
    Route::post('/detail-nilai-proyek', function (Request $request) {
        ...
        if (isset($is_bpmcsrf_exist)) {
            ...
            $proyeks = Proyek::where("unit_kerja", "=", $request->unitkerjaid)->where("is_cancel", "!=", true)->get(["nama_proyek", "stage", "kode_proyek", "unit_kerja", "jenis_proyek", "nilai_perolehan"])->where("stage", "!=", 8)->where("stage", "!=", 7);
