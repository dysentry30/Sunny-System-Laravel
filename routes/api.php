...
Route::middleware(["web"])->group(function () {
    ...
    Route::post('/detail-nilai-proyek', function (Request $request) {
        ...
        if (isset($is_bpmcsrf_exist)) {
            ...
            $proyeks = HistoryForecast::join("proyeks", "proyeks.kode_proyek", "=", "history_forecast.kode_proyek")->where("unit_kerja", "=", $request->unitkerjaid)->get(["nama_proyek", "stage", "kode_proyek", "unit_kerja", "jenis_proyek", "tipe_proyek", "nilai_perolehan", "is_cancel"])->where("stage", "!=", 7)->where("is_cancel", "!=", true);
