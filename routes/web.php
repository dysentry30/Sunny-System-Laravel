...
Route::group(['middleware' => ["userAuth", "admin"]], function () {
    ...
    Route::post('/contract-management/{kategori_file}/upload', [ContractManagementsController::class, 'uploadDokumenContract'
    ]);
    ...
    // DOWNLOAD CV Personel Tender 
    Route::post('/proyek/personel-tender/{personel}/download', [ProyekController::class, 'downloadCVPersonel']);
     ...
     * @return \Illuminate\Support\Facades\Response JSON {Success, Message}
     */
