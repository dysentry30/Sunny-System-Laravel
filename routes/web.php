...
Route::group(['middleware' => ["userAuth", "admin"]], function () {
    ...
    Route::get('/history-autorisasi', function () {
        ...
        if ($periodeOtor == 1) {
            $history_forecasts = HistoryForecast::join("proyeks", "proyeks.kode_proyek", "=", "history_forecast.kode_proyek")->where("periode_prognosa", "=", $periodeOtor - 1)->whereYear("created_at", "=", (int) date("Y") - 1)->where("stage", "!=", 7)->where("is_cancel", "!=", true)->join("dops", "dops.dop", "=", "proyeks.dop")->join("unit_kerjas", "unit_kerjas.divcode", "=", "proyeks.unit_kerja");
        } else {
            $history_forecasts = HistoryForecast::join("proyeks", "proyeks.kode_proyek", "=", "history_forecast.kode_proyek")->where("periode_prognosa", "=", $periodeOtor - 1)->join("dops", "dops.dop", "=", "proyeks.dop")->where("stage", "!=", 7)->where("is_cancel", "!=", true)->join("unit_kerjas", "unit_kerjas.divcode", "=", "proyeks.unit_kerja");
        }
