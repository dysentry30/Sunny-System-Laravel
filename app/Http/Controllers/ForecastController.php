    ...
    public function index(Request $request, $periode = "", $year = "")
    {
        ...
        if (Auth::user()->check_administrator) {
            ...
            if ($unit_kerja_user instanceof \Illuminate\Support\Collection) {
                ...
                $nilaiRKAP = Proyek::join("proyeks", "proyeks.kode_proyek", "=", "forecasts.kode_proyek")->all()->whereIn("unit_kerja", $unit_kerja_user->toArray())->where("jenis_proyek", "!=", "I")->whereYear("forecasts.created_at", "=", $year);
            } else {
                ...
                $nilaiRKAP = Proyek::join("proyeks", "proyeks.kode_proyek", "=", "forecasts.kode_proyek")->all()->whereIn("unit_kerja", Auth::user()->unit_kerja)->where("jenis_proyek", "!=", "I")->whereYear("forecasts.created_at", "=", $year);
            }
        }
