...
class AdminAuth
{
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        $allowed_url_user_sales = join(" ", ["dashboard", "customer", "forecast", "proyek", "knowledge-base", "company", "sumber-dana", "pasal", "user", "team-proyek", "dop", "sbu", "unit-kerja", "kriteria-pasar", "get-kabupaten", "get-kabupaten-coordinate"]);
