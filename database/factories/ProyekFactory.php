...
class ProyekFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            "sumber_dana" => $this->faker->randomElement(["BUMN", "SWASTA"]),
            "jenis_proyek" => $jenis_proyek,
            "tipe_proyek" => $tipe_proyek,
            "stage" => $this->faker->randomElement([1, 2, 3, 4, 5, 6, 7, 8, 9]),
            ...
            "hps_pagu" => $this->faker->numerify('###,000'),
            "porsi_jo" => $this->faker->numerify('100'),
            "ketua_tender" => $this->faker->name(),
            "laporan_prakualifikasi" => $this->faker->text(100),

            // Tender Diikuti   
            "jadwal_tender" => $this->faker->date(),
            "penawaran_tender" => $this->faker->numerify('#,###,000'),
            "lokasi_tender" => $this->faker->address(),
            // "hps_tender" => $this->faker->numerify('#,###,000'),
            "laporan_tender" => $this->faker->text(100),

            // Perolehan   
            "biaya_praproyek" => $this->faker->numerify('#,###,000'),
            // "penawaran_perolehan" => $this->faker->numerify('#,###,000'),
            // "nilai_perolehan" => $this->faker->numerify('#,###,000'),
