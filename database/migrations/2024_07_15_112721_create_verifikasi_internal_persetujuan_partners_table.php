...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('verifikasi_internal_persetujuan_partners')) {
            Schema::create('verifikasi_internal_persetujuan_partners', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('verifikasi_internal_persetujuan_partners');
    }
};
