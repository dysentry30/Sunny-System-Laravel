...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('matriks_approval_paparan')) {
            Schema::create('matriks_approval_paparan', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('matriks_approval_paparans');
    }
};
