...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('matriks_approval_persetujuan_partner')) {
            Schema::create('matriks_approval_persetujuan_partner', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('matriks_approval_persetujuan_partner');
    }
};
