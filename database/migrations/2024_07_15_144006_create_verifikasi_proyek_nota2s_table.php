...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('verifikasi_proyek_nota_2')) {
            Schema::create('verifikasi_proyek_nota_2', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('verifikasi_proyek_nota_2');
    }
};
