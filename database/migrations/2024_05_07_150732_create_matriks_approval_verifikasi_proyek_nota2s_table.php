...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('matriks_approval_verifikasi_proyek_nota_2')) {
            Schema::create('matriks_approval_verifikasi_proyek_nota_2', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('matriks_approval_verifikasi_proyek_nota_2');
    }
};
